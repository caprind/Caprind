...
Begin VB.Form frmEstoque_localizar_item 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   Caption         =   "Estoque | Movimentação | Gerar sucata/retalho | Localizar produtos"
   ClientHeight    =   6135
   ClientLeft      =   0
   ClientTop       =   -105
   ClientWidth     =   9120
   ...
   Begin DrawSuite2022.USForm USForm1 
      ...
      _ExtentX        =   16087
      _ExtentY        =   714
      DibPicture      =   "frmEstoque_localizar_item.frx":0000
      CaptionDelimiter=   "|"
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Icon            =   "frmEstoque_localizar_item.frx":3650
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmEstoque_localizar_item.frx":396A
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmEstoque_localizar_item.frx":7114
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmEstoque_localizar_item.frx":AC2F
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmEstoque_localizar_item.frx":ED29
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin DrawSuite2022.USButton btnFiltrar 
         ...
         _ExtentX        =   3201
         _ExtentY        =   1085
         DibPicture      =   "frmEstoque_localizar_item.frx":125F9
         BorderColor     =   5263559
      ...
      Begin VB.ComboBox Cmb_ordenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmEstoque_localizar_item.frx":15C49
         Left            =   4200
         List            =   "frmEstoque_localizar_item.frx":15C53
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmEstoque_localizar_item.frx":15C72
         Left            =   180
         List            =   "frmEstoque_localizar_item.frx":15C91
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmEstoque_localizar_item"
...
If frmEstoque_sucata.optSucata.Value = True Then TipoFiltro = "P.vendas = 'True'" Else TipoFiltro = "P.desenho IS NOT NULL"
If Cmb_ordenar = "Código interno" Then Ordenar = "P.desenho" Else Ordenar = "P.Descricao"
TextoFiltroPadrao = TipoFiltro & " group by " & CamposFiltro & " order by " & Ordenar
...
ProcFiltroPadrao cmbfiltrarpor, Optmeio, Optfim, optIgual, frmFaturamento_Prod_Serv.txtIDEmpresa.Text, "Produtos/Serviços", "T", True
...
With frmEstoque_sucata
    .OPTnovo.Value = 0
    .OPTnovoman.Value = 0
    Set TBItem = CreateObject("adodb.recordset")
    TBItem.Open "select Desenho, Revdesenho, Unidade, unidade_com, descricaotecnica, Classe, Espessura, Comprimento, Largura, Dureza from projproduto where codproduto = " & ListView1.SelectedItem, Conexao, adOpenKeyset, adLockOptimistic
    If TBItem.EOF = False Then
        .txtDesenho_sucata = IIf(IsNull(TBItem!Desenho), "", TBItem!Desenho)
        .txtRev_cod = IIf(IsNull(TBItem!RevDesenho), "", TBItem!RevDesenho)
        .txtUnEntrada = IIf(IsNull(TBItem!Unidade), "", TBItem!Unidade)
        .txtUN_com_sucata = IIf(IsNull(TBItem!Unidade_com), "", TBItem!Unidade_com)
        .txtDesc_sucata = IIf(IsNull(TBItem!descricaotecnica), "", TBItem!descricaotecnica)
        .txtespessura = IIf(IsNull(TBItem!Espessura), "", TBItem!Espessura)
        .txtComprimento = IIf(IsNull(TBItem!Comprimento), "", TBItem!Comprimento)
        .txtLargura = IIf(IsNull(TBItem!Largura), "", TBItem!Largura)
        .txtDureza = IIf(IsNull(TBItem!Dureza), "", TBItem!Dureza)
        If TBItem!Classe <> "" And IsNull(TBItem!Classe) = False Then .cmbfamilia = TBItem!Classe
    End If
    TBItem.Close
End With
Unload Me
