            ...
            If TBContas.EOF = False Then
                If txtStatus.Text = "Liberada" Then
                    ...
                    If TBAbrir.EOF = False Then
                        TBContas!status = "TÍTULO RECEBIDO PARCIAL"
                    Else
                        Set TBAbrir = CreateObject("adodb.recordset")
                        TBAbrir.Open "Select * from tbl_contas_receber where IdIntConta = " & TBContas!IDintconta, Conexao, adOpenKeyset, adLockOptimistic
                        If TBAbrir.EOF = False Then
                            If TBAbrir!titulodesc = True Then TBContas!status = "DUPLICATA DESCONTADA EM ABERTO" Else TBContas!status = "TÍTULO EM ABERTO"
                        End If
                   End If
                   TBAbrir.Close
