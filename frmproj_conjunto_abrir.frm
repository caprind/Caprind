...
Begin VB.Form frmproj_conjunto_abrir 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Engenharia - Conjuntos - Localizar"
   ClientHeight    =   6375
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   8895
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmproj_conjunto_abrir.frx":0000
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmproj_conjunto_abrir.frx":37A7
         Caption         =   ""
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmproj_conjunto_abrir.frx":72BD
         Caption         =   ""
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmproj_conjunto_abrir.frx":B3B7
         Caption         =   ""
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Cmd_excluir 
         ...
         Height          =   315
         Left            =   5910
         Picture         =   "frmproj_conjunto_abrir.frx":EC6E
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton Cmd_salvar 
         ...
         Height          =   315
         Left            =   5580
         Picture         =   "frmproj_conjunto_abrir.frx":EDAC
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.ComboBox Cmb_ordenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmproj_conjunto_abrir.frx":EDFF
         Left            =   6330
         List            =   "frmproj_conjunto_abrir.frx":EE09
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmproj_conjunto_abrir.frx":EE28
         Left            =   180
         List            =   "frmproj_conjunto_abrir.frx":EE56
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   Begin DrawSuite2022.USToolBar USToolBar1 
      ...
      Begin DrawSuite2022.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "frmproj_conjunto_abrir.frx":EF1C
         Count           =   1
      End
   End
   ...
   End
End
Attribute VB_Name = "frmproj_conjunto_abrir"
...
CamposFiltro = "P.codProduto, P.Desenho, P.Descricao, P.Unidade, P.classe, PC.Versao"
INNERJOINTEXTO = "Select " & CamposFiltro & " from (((((Projproduto P LEFT JOIN projconjunto PC ON PC.Codproduto = P.Codproduto) LEFT JOIN item_aplicacoes IA ON P.codproduto = IA.codproduto) LEFT JOIN Projproduto_clientes PCLI ON P.codproduto = PCLI.codproduto) LEFT JOIN Projproduto_fornecedor PF ON P.codproduto = PF.codproduto) LEFT JOIN Projproduto_fabricante PFAB ON PFAB.Codproduto = P.codproduto) LEFT JOIN Projconjunto_desc_versao PCDV ON PCDV.Codproduto = P.Codproduto and PCDV.Versao = PC.Versao"
If Cmb_ordenar = "Código interno" Then Ordenar = "P.desenho" Else Ordenar = "P.Descricao"
TextoFiltroPadrao = "P.Subtipoitem <> 0 and P.Subtipoitem <> 4 group by " & CamposFiltro & " order by " & Ordenar & ", PC.Versao"
    ...
    If txtTexto.Visible = True And txtTexto <> "" Or cmbfamilia.Visible = True And cmbfamilia <> "" Then
        If cmbfiltrarpor = "Cliente" Or cmbfiltrarpor = "Fornecedor" Or cmbfiltrarpor = "Família" Then
            Select Case cmbfiltrarpor
                Case "Cliente": TextoFiltro = "PCLI.IDCliente"
        ...
        ElseIf cmbfiltrarpor = "Comprimento" Or cmbfiltrarpor = "Largura" Or cmbfiltrarpor = "Espessura" Then
            ...
            Else
                Select Case cmbfiltrarpor
                    ...
                    Case "Descrição da versão": TextoFiltro = "PCDV.Descricao"
                End Select
    ...
    With Lista
        For InitFor = 1 To .ListItems.Count
            If .ListItems(InitFor).ListSubItems(1) = "Cliente" Or .ListItems(InitFor).ListSubItems(1) = "Fornecedor" Then
                If .ListItems(InitFor).ListSubItems(1) = "Cliente" Then TextoFiltro = "PCLI.IDCliente" Else TextoFiltro = "PF.IDfornecedor"
...
If Compras = True Then Caption = "Compras - Conjuntos - Localizar"
If Vendas = True Then Caption = "Vendas - Conjuntos - Localizar"
ProcCarregaComboFamilia cmbfamilia, "familia <> 'Null' and (compras = 'False' or compras = 'True' and vendas = 'True')", True
...
With frmproj_conjunto
    ...
    .ProcLimpaCampos
    .ProcLimpaCamposItem
    .Procatualizadados (ListView1.SelectedItem.ListSubItems(1))
    .ProcCarregaVersao (ListView1.SelectedItem.ListSubItems(5))
    .Novo_Conjunto = False
End With
Unload Me
...
Do While TBLocalizar_produto_padrao.EOF = False And (ContadorReg <= TamanhoPagina)
    With ListView1.ListItems
        ...
        .Item(.Count).SubItems(5) = IIf(IsNull(TBLocalizar_produto_padrao!versao), "", TBLocalizar_produto_padrao!versao)
    End With
