...
Begin VB.Form frmEstoque_Movimentacao_Exportar 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   ...
   Begin VB.Frame Frame1 
      ...
      Begin DrawSuite2022.USButton btnExcell 
         ...
         _ExtentX        =   6588
         _ExtentY        =   1984
         DibPicture      =   "frmEstoque_Movimentacao_Exportar.frx":0000
      ...
      Begin DrawSuite2022.USButton btnPDF 
         ...
         _ExtentX        =   6588
         _ExtentY        =   2090
         DibPicture      =   "frmEstoque_Movimentacao_Exportar.frx":65C5
         BorderColorDown =   15048022
         BorderColorOver =   15381630
   ...
   Begin DrawSuite2022.USForm USForm1 
      ...
      _ExtentX        =   8546
      _ExtentY        =   741
      DibPicture      =   "frmEstoque_Movimentacao_Exportar.frx":1CFDD
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Icon            =   "frmEstoque_Movimentacao_Exportar.frx":1FB00
      ShowMaximize    =   0   'False
      ShowMinimize    =   0   'False
   End
End
Attribute VB_Name = "frmEstoque_Movimentacao_Exportar"
...
With frmestoque_Movimentacao.GridProdutos
...
With frmestoque_Movimentacao.GridProdutos
        ...
        .PageSetup.Header = "Estoque movimentação resumido até " & frmestoque_Movimentacao.Ate
