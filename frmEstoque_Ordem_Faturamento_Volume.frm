...
Begin VB.Form frmEstoque_Ordem_Faturamento_Volume 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   Caption         =   "Ordem de faturamento | Lista de itens x embalagem"
   ClientHeight    =   6240
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6525
   ...
   Begin DrawSuite2022.USForm USForm1 
      ...
      _ExtentX        =   11509
      _ExtentY        =   767
      DibPicture      =   "frmEstoque_Ordem_Faturamento_Volume.frx":0000
      CaptionDelimiter=   "|"
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Icon            =   "frmEstoque_Ordem_Faturamento_Volume.frx":1CAD
   End
   ...
   End
End
Attribute VB_Name = "frmEstoque_Ordem_Faturamento_Volume"
...
If USMsgBox("Deseja realmente carregar o numero de volumes?", vbYesNo, "CAPRIND v5.0") = vbYes Then
        ...
        frmEstoque_Ordem_Faturamento.txtTransp_qtd.Text = Int(txtTotalVolumes.Text)
