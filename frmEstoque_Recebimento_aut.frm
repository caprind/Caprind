...
Begin VB.Form frmEstoque_Recebimento_aut 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Estoque - Recebimento - Selecionar autorizado"
   ClientHeight    =   2070
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   4050
   ...
   EndProperty
   ForeColor       =   &H8000000D&
   Icon            =   "frmEstoque_Recebimento_aut.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmEstoque_Recebimento_aut.frx":0442
      Count           =   1
   End
   ...
   End
End
Attribute VB_Name = "frmEstoque_Recebimento_aut"
