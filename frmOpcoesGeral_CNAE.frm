...
Begin VB.Form frmOpcoesGeral_CNAE 
   ...
   Caption         =   "Configurações do sistema - Opções gerais - Código atividade do CNAE"
   ClientHeight    =   5550
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   9150
    ...
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            If Permitido = False Then
                If USMsgBox("Deseja realmente excluir este(s) código(s)?", vbYesNo, "CAPRIND v5.0") = vbNo Then Exit Sub
            End If
            Permitido = True
            
            '==================================
            Modulo = "Configuração do sistema/Opções gerais/Código atividade do CNAE"
            Evento = "Excluir"
...
End With
If Permitido = False Then
    USMsgBox ("Informe o(s) código(s) antes de excluir."), vbExclamation, "CAPRIND v5.0"
Else
    USMsgBox ("Código(s) excluído(s) com sucesso."), vbInformation, "CAPRIND v5.0"
    ProcLimpaCampos
...
If txtCodigo.Text = "" Then
    USMsgBox ("Informe o código antes de salvar."), vbExclamation, "CAPRIND v5.0"
    txtCodigo.SetFocus
    Exit Sub
End If
If txtdescricao.Text = "" Then
    USMsgBox ("Informe a descrição antes de salvar."), vbExclamation, "CAPRIND v5.0"
...
If Novo_CodigoAtividade = True Then
    USMsgBox ("Novo código cadastrado com sucesso."), vbInformation, "CAPRIND v5.0"
    Evento = "Novo"
Else
...
If Novo_CodigoAtividade = True Then
    If USMsgBox("O código ainda não foi salvo, deseja salvar antes de fechar o módulo?", vbYesNo) = vbYes Then
        ProcSalvar
        If Novo_CodigoAtividade = True Then
            Exit Sub
        Else
