...
Begin VB.Form frmEstoque_Recebimento_Importacao_xml 
   Caption         =   "Importar XML da nota fiscal eletrônica de entrada"
   ClientHeight    =   10035
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   15360
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmEstoque_Recebimento_Importacao_xml.frx":0000
      ...
      TabPicture(1)   =   "frmEstoque_Recebimento_Importacao_xml.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Lista"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Dados transporte/Inf. adicionais"
      TabPicture(2)   =   "frmEstoque_Recebimento_Importacao_xml.frx":0038
      ...
      TabPicture(3)   =   "frmEstoque_Recebimento_Importacao_xml.frx":0054
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.ComboBox Cmb_empresa 
            ...
            ForeColor       =   &H00000000&
            Height          =   330
            ItemData        =   "frmEstoque_Recebimento_Importacao_xml.frx":0070
            Left            =   10140
            List            =   "frmEstoque_Recebimento_Importacao_xml.frx":0072
            Sorted          =   -1  'True
   ...
   Begin DrawSuite2022.USToolBar USToolBar1 
      ...
      Begin DrawSuite2022.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "frmEstoque_Recebimento_Importacao_xml.frx":0074
         Count           =   1
      End
   End
End
Attribute VB_Name = "frmEstoque_Recebimento_Importacao_xml"
...
End If
    ...
    TBClientes.Open "Select * from Compras_fornecedores where CPF_CNPJ = '" & CNPJ.Text & "'", Conexao, adOpenKeyset, adLockOptimistic
...
'Else
'USMsgBox "Atenção, nãos será possivel executar a operação de criação pois já existe cadastro da nota fiscal " & nNF.Text & " do cliente " & xNome.Text & " no banco de dados.", vbCritical, "CAPRIND v5.0"
'Exit Sub
'End If
...
'If USMsgBox("Deseja prosseguir com o preenchimento dos dados da nota fiscal?", vbyesno, "CAPRIND v5.0") = vbYes Then
'
