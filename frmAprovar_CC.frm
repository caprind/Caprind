...
Begin VB.Form frmAprovar_CC 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Autorização de centro de custo"
   ClientHeight    =   2070
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   4050
   ...
   Begin DrawSuite2022.USToolBar USToolBar1 
      ...
      ButtonIconSize1 =   32
      ButtonToolTipText1=   "Autorizar centro de custo sem previsão (F3)"
      ButtonKey1      =   "1"
      ButtonAlignment1=   2
   ...
   End
End
Attribute VB_Name = "frmAprovar_CC"
...
If TBUsuarios.EOF = False Then
    Set TBAcessos = CreateObject("adodb.recordset")
    TBAcessos.Open "select * from acessos where IDUsuario = " & TBUsuarios!IDUsuario & " and Acesso = '" & Formulario & "' and Validacao = 'True'", Conexao, adOpenKeyset, adLockOptimistic
