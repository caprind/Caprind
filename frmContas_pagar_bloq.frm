...
Begin VB.Form frmContas_pagar_bloq 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Administrativo - Financeiro - Contas a pagar - Status"
   ClientHeight    =   3930
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   6420
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmContas_pagar_bloq.frx":0000
      Count           =   1
   End
   ...
   End
End
Attribute VB_Name = "frmContas_pagar_bloq"
...
If txtStatus = "" Then
    USMsgBox ("Informe se a conta está bloqueada ou liberada antes de salvar."), vbExclamation, "CAPRIND v5.0"
    Exit Sub
End If
        ...
        If .lst_contas.ListItems.Item(InitFor).Checked = True Then
            ...
            If TBContas.EOF = False Then
                If txtStatus.Text = "Liberada" Then
                    ...
                    TBAbrir.Open "Select * from tbl_ContasPagar where tituloref = '" & TBContas!IDintconta & "' and IdIntConta <> " & TBContas!IDintconta & " and Logsit = 'S'", Conexao, adOpenKeyset, adLockOptimistic
                    If TBAbrir.EOF = False Then
                        TBContas!status = "TÍTULO PAGO PARCIAL"
                    Else
                ...
                'Centro de custo
                Conexao.Execute "Update CC_realizado Set " & Bloqueado & " where ID_financeiro = " & TBContas!IDintconta
...
With frmContas_Pagar
    ...
    For InitFor = 1 To .lst_contas.ListItems.Count
        If .lst_contas.ListItems.Item(InitFor).Checked = True Then
            IDAntigo = .lst_contas.ListItems(InitFor)
            contador = contador + 1
        End If
    Next InitFor
    
    Set TBContas = CreateObject("adodb.recordset")
    TBContas.Open "Select * from tbl_ContasPagar where IdIntConta = " & IDAntigo, Conexao, adOpenKeyset, adLockOptimistic
    If TBContas.EOF = False Then
