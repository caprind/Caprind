...
Begin VB.Form frmEstoque_Retirar_NumeroSerieDisponiveis 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   Caption         =   "Numero de série disponíveis"
   ClientHeight    =   6300
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5580
...
Select Case KeyCode
    ...
    If Lista.ListItems.Count > 0 Then
        If USMsgBox("Deseja utilizar o numero de série " & Lista.SelectedItem.ListSubItems.Item(1).Text & " no apontamento?", vbYesNo, "GERPROD") = vbYes Then
