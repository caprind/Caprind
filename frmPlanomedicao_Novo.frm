...
Begin VB.Form frmPlanomedicao_Novo 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Qualidade - Controle de medição - Novo"
   ClientHeight    =   7215
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   12495
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmPlanomedicao_Novo.frx":0000
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmPlanomedicao_Novo.frx":37AA
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmPlanomedicao_Novo.frx":72C3
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmPlanomedicao_Novo.frx":B3BD
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmPlanomedicao_Novo.frx":EC8B
         Left            =   180
         List            =   "frmPlanomedicao_Novo.frx":EC9E
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmPlanomedicao_Novo.frx":ECE3
      Count           =   1
   End
   ...
   End
End
Attribute VB_Name = "frmPlanomedicao_Novo"
...
If txtTexto.Visible = True And txtTexto <> "" Or cmbfamilia.Visible = True And cmbfamilia <> "" Then
    If cmbfiltrarpor = "Família" Then
        StrSqlLocProdPadrao = "Select * from Qtde_inspecionar_produzidos where classe = '" & cmbfamilia & "' and (Qtde_inspecionar > 0 or Qtde_inspecionar1 > 0) order by ordem"
    ElseIf cmbfiltrarpor = "Ordem" Then
            StrSqlLocProdPadrao = "Select * from Qtde_inspecionar_produzidos where ordem = " & txtTexto.Text & " and (Qtde_inspecionar > 0 or Qtde_inspecionar1 > 0) order by Ordem"
        Else
            ...
            End Select
            StrSqlLocProdPadrao = "Select * from Qtde_inspecionar_produzidos where " & TextoFiltro & FunVerifTipoFiltroIMF(Optinicio, Optmeio, Optfim, optIgual, txtTexto) & " and (Qtde_inspecionar > 0 or Qtde_inspecionar1 > 0) order by Ordem"
    End If
Else
    StrSqlLocProdPadrao = "Select * from Qtde_inspecionar_produzidos where Qtde_inspecionar > 0 or Qtde_inspecionar1 > 0 order by Ordem"
End If
ProcCarregaLista
...
If Permitido = False Then cmbfiltrarpor = "Ordem"
...
Do While TBLocalizar_produto_padrao.EOF = False And (ContadorReg <= TamanhoPagina)
    With ListView1.ListItems
        .Add , , TBLocalizar_produto_padrao!IDFase
        .Item(.Count).SubItems(1) = TBLocalizar_produto_padrao!Ordem
        .Item(.Count).SubItems(2) = TBLocalizar_produto_padrao!IDProducao
        .Item(.Count).SubItems(3) = TBLocalizar_produto_padrao!Fase
        .Item(.Count).SubItems(4) = IIf(IsNull(TBLocalizar_produto_padrao!versao), "", TBLocalizar_produto_padrao!versao)
        .Item(.Count).SubItems(5) = IIf(IsNull(TBLocalizar_produto_padrao!maquina), "", TBLocalizar_produto_padrao!maquina)
        .Item(.Count).SubItems(6) = IIf(IsNull(TBLocalizar_produto_padrao!Descricao), "", TBLocalizar_produto_padrao!Descricao)
        .Item(.Count).SubItems(7) = IIf(IsNull(TBLocalizar_produto_padrao!Grupo_op), "", TBLocalizar_produto_padrao!Grupo_op)
        .Item(.Count).SubItems(8) = IIf(IsNull(TBLocalizar_produto_padrao!Desenho), "", TBLocalizar_produto_padrao!Desenho)
        .Item(.Count).SubItems(9) = IIf(IsNull(TBLocalizar_produto_padrao!Produto), "", TBLocalizar_produto_padrao!Produto)
        .Item(.Count).SubItems(10) = IIf(IsNull(TBLocalizar_produto_padrao!Unidade), "", TBLocalizar_produto_padrao!Unidade)
    End With
