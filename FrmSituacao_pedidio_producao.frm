...
Begin VB.Form FrmSituacao_pedidio_producao 
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   Icon            =   "FrmSituacao_pedidio_producao.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10035
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox cmbTipoData 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "FrmSituacao_pedidio_producao.frx":000C
         Left            =   720
         List            =   "FrmSituacao_pedidio_producao.frx":001C
         Sorted          =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmbOrdenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "FrmSituacao_pedidio_producao.frx":0048
         Left            =   9060
         List            =   "FrmSituacao_pedidio_producao.frx":0055
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   3
         ToolTipText     =   "Ordenar."
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "FrmSituacao_pedidio_producao.frx":0076
         Left            =   180
         List            =   "FrmSituacao_pedidio_producao.frx":00A4
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   Begin DrawSuite2014.USToolBar USToolBar1 
      ...
      ButtonWidth6    =   24
      ButtonHeight6   =   24
      Begin DrawSuite2014.USButton btnAlterarLista 
         Height          =   465
         Left            =   13350
         TabIndex        =   97
         Top             =   210
         ...
         BorderColorDown =   16777215
         BorderColorOver =   16777215
      ...
      Begin DrawSuite2014.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "FrmSituacao_pedidio_producao.frx":016C
         Count           =   1
      End
   End
   ...
   Begin VB.Frame Frame30 
      ...
      Begin VB.CommandButton cmd_Visualizar_arquivo 
         ...
         Height          =   315
         Left            =   1980
         Picture         =   "FrmSituacao_pedidio_producao.frx":2F60
         Style           =   1  'Graphical
         TabIndex        =   29
   ...
   Begin VB.Frame FrameOS 
      ...
      Begin VB.CheckBox chkPchora 
         ...
         Width           =   1425
      End
      Begin DrawSuite2014.USButton Cmd_abrir_apontamento 
         Height          =   525
         Left            =   13110
         TabIndex        =   50
      ...
      Begin RichTextLib.RichTextBox txtDescricao 
         ...
         BorderStyle     =   0
         ScrollBars      =   2
         TextRTF         =   $"FrmSituacao_pedidio_producao.frx":3522
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "FrmSituacao_pedidio_producao"
...
Pula:
        ...
        TBOrdem.Open "Select * from producao where Ordem = " & Texto2, Conexao, adOpenKeyset, adLockOptimistic
...
If Screen.ActiveForm.Name = "FrmSituacao_pedidio_producao" Then
