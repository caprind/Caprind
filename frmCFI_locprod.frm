...
Begin VB.Form frmCFI_locprod 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Estoque - Almoxarifado - Localizar produtos"
   ClientHeight    =   6345
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   8895
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCFI_locprod.frx":0000
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCFI_locprod.frx":37A7
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCFI_locprod.frx":72B5
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCFI_locprod.frx":B3A9
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Cmb_ordenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCFI_locprod.frx":10E23
         Left            =   6330
         List            =   "frmCFI_locprod.frx":10E2D
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCFI_locprod.frx":10E4C
         Left            =   180
         List            =   "frmCFI_locprod.frx":10E6B
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmCFI_locprod"
...
If Qualidade_Almox = True Then TextoFiltroInst = "and P.Instrumento = 'True'" Else TextoFiltroInst = ""
With frmCFI
    If .CFI_devolucao = True Or .CFI_saida = True Then
        TipoFiltro = "P.SubTipoItem = 3"
    ElseIf Qualidade_Almox = True Then
            TipoFiltro = "P.Qualidade = 'True'"
        Else
            TipoFiltro = "P.compras = 'True'"
        End If
End With
...
TextoFiltroPadrao = "P.Tipo <> 'S' and " & TipoFiltro & " and P.Bloqueado = 'False' " & TextoFiltroInst & " group by " & CamposFiltro & " order by " & Ordenar
...
If Qualidade_Almox = True Then
    Caption = "Qualidade - Almoxarifado - Localizar produtos"
...
With frmCFI
    If .CFI_devolucao = True Or .CFI_saida = True Then
        ...
        TBEstoque.Open "Select * from CFI_Itens where id_CFI = " & .txtID & " and codProduto = " & Lista.SelectedItem, Conexao, adOpenKeyset, adLockOptimistic
        If TBEstoque.EOF = False Then
            USMsgBox ("Este produto já foi adicionado a lista."), vbExclamation, "CAPRIND v5.0"
            Exit Sub
        End If
        TBEstoque.AddNew
        TBEstoque!Codproduto = Lista.SelectedItem
        TBEstoque!Id_cfi = .txtID
        TBEstoque.Update
        '==================================
        Modulo = Formulario
        Evento = "Novo produto de destino/aplicação"
        ID_documento = TBEstoque!ID
        Documento = "Cód. interno: " & Lista.SelectedItem.SubItems(1)
        Documento1 = ""
        ProcGravaEvento
        '==================================
        TBEstoque.Close
        USMsgBox ("Produto adicionado a lista com sucesso."), vbInformation, "CAPRIND v5.0"
        If .CFI_saida = True Then frmCFI_Saida.ProcCarregaLista Else frmCFI_Devolucao.ProcCarregaLista
    Else
        .txtCodinterno.Text = Lista.SelectedItem.ListSubItems(1)
        .txtdescricao.Text = Lista.SelectedItem.ListSubItems(2)
        .txtFamilia.Text = Lista.SelectedItem.ListSubItems(4)
        .txtquantestoque = Lista.SelectedItem.SubItems(5)
        Unload Me
    End If
End With
...
Do While TBLocalizar_produto_padrao.EOF = False And (ContadorReg <= TamanhoPagina)
    With Lista.ListItems
        ...
        .Item(.Count).SubItems(5) = Format(FunVerificaQtdeEstoque(TBLocalizar_produto_padrao!Desenho, 0, ""), "###,##0.0000")
    End With
