...
Begin VB.Form frmFaturamento_CartaCorrecao 
   BackColor       =   &H00E0E0E0&
   ...
   Begin VB.TextBox Txt_ID_nota 
      ...
      Left            =   8340
      Locked          =   -1  'True
      MouseIcon       =   "frmFaturamento_CartaCorrecao.frx":0000
      TabIndex        =   39
      TabStop         =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin DrawSuite2014.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmFaturamento_CartaCorrecao.frx":030A
      ...
      Begin DrawSuite2014.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmFaturamento_CartaCorrecao.frx":3AB1
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2014.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmFaturamento_CartaCorrecao.frx":75BF
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2014.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmFaturamento_CartaCorrecao.frx":B6B3
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Cmd_localizar_NF 
         ...
         Height          =   315
         Left            =   1350
         Picture         =   "frmFaturamento_CartaCorrecao.frx":EF40
         Style           =   1  'Graphical
         TabIndex        =   40
      ...
      Begin VB.ComboBox Cmb_empresa 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmFaturamento_CartaCorrecao.frx":F042
         Left            =   180
         List            =   "frmFaturamento_CartaCorrecao.frx":F044
         Sorted          =   -1  'True
   ...
   Begin DrawSuite2014.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmFaturamento_CartaCorrecao.frx":F046
      Count           =   1
   End
   Begin DrawSuite2014.USToolBar USToolBar1 
      ...
      ButtonCaption9  =   "Log CC-e"
      ButtonEnabled9  =   0   'False
      ButtonIconSize9 =   32
      ButtonToolTipText9=   "Log CC-e"
      ButtonKey9      =   "9"
      ButtonAlignment9=   2
   ...
   End
End
Attribute VB_Name = "frmFaturamento_CartaCorrecao"
...
'Dim emailNF As String
Dim NomeArquivo As String
Dim ChaveMigrate As String
Dim CnpjNF As String
Dim DiretorioEnvio As String
Dim DiretorioXMLDanfe As String
Dim DiretorioRetorno As String
...
Novo = False
frmFaturamento_CartaCorrecao_Localizar.Show 1
...
TBGravar!Obs = Replace(Trim(txtobs), vbCrLf, " ")
...
Do While TBLISTA_Carta.EOF = False And (ContadorReg <= TamanhoPagina)
    With Lista.ListItems
        ...
        .Item(.Count).SubItems(7) = funStatus(IIf(IsNull(TBLISTA_Carta!status), "", TBLISTA_Carta!status))
    End With
...
If TBproducao.EOF = False Then
    MsgBox ("Só é possível enviar carta de correção de notas aprovadas."), vbExclamation
    TBproducao.Close
    Exit Sub
End If
...
If MsgBox("Deseja enviar esta carta de correção?", vbQuestion + vbYesNo) = vbYes Then
    NomeArquivo = "CC" & txtNF & Txt_serie
    procEnviarXML
    procAcionaTimer
End If
...
'Abre EnvioEvento======================================================================================================
    ...
    'Abre Evento===================================================================================================
        ...
        objEvento.childNodes(1).Text = Format(txtNF, "0")
        objEvento.appendChild objDom.createElement("NtfSerie")
        objEvento.childNodes(2).Text = Txt_serie
        ...
        'Abre EveInf===================================================================================================
            ...
            objEveInf.childNodes(2).Text = "110110"
            ...
            'Abre EveInf===================================================================================================
                ...
                objEvedet.childNodes(0).Text = "Carta de Correcao"
                objEvedet.appendChild objDom.createElement("EveCorrecao")
                objEvedet.childNodes(1).Text = Replace(Trim(txtobs), vbCrLf, " ")
                objEvedet.appendChild objDom.createElement("EveCondUso")
                objEvedet.childNodes(2).Text = "A Carta de Correcao e disciplinada pelo paragrafo 1o-A do art. 7o do Convenio S/N, de 15 de dezembro de 1970 e pode ser utilizada para regularizacao de erro ocorrido na emissao de documento fiscal, desde que o erro nao esteja relacionado com: I - as variaveis que determinam o valor do imposto tais como: base de calculo, aliquota, diferenca de preco, quantidade, valor da operacao ou da prestacao; II - a correcao de dados cadastrais que implique mudanca do remetente ou do destinatario; III - a data de emissao ou de saida."
            'Fecha EveInf==================================================================================================
        'Fecha EveInf==================================================================================================
    'Fecha Evento==================================================================================================
'Fecha EnvioEvento===============================================================================================================
...
Set TBFI = CreateObject("adodb.recordset")
TBFI.Open "Select E.UF, E.Cidade, E.CNPJ, E.ChaveMigrate, E.Caminho_Nfe, E.Caminho_XMLDanfe, E.Caminho_RetornoNfe from Empresa E INNER JOIN tbl_Dados_Nota_Fiscal N ON E.Codigo = N.ID_empresa where N.ID = " & Txt_ID_nota, Conexao, adOpenKeyset, adLockReadOnly
If TBFI.EOF = False Then
    CnpjNF = IIf(IsNull(TBFI!CNPJ), "", TBFI!CNPJ)
    ChaveMigrate = IIf(IsNull(TBFI!ChaveMigrate), "", TBFI!ChaveMigrate)
...
NotaXML = FunTamanhoTextoZeroEsq(txtNF, 9)
SerieXML = FunTamanhoTextoZeroEsq(Txt_serie, 5)
formaXML = False

success = doc.Load(DiretorioRetorno & "\NFe\" & cnpjXML & NotaXML & SerieXML & "11011001-ret.xml")
...
If statusXML <> "" Then
    Conexao.Execute "Update NF_Carta_Correcao Set Status = " & statusXML & " where id_nota = " & Txt_ID_nota
    txtStatus = funStatus(statusXML)
    
    If statusXML = "135" Then
        If MsgBox("Deseja visualizar a carta de correção?", vbQuestion + vbYesNo) = vbYes Then procAbrirNotaPDF "NFe", CnpjNF, txtNF, Txt_serie, DiretorioXMLDanfe, True
    End If
End If
