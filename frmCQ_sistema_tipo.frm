...
Begin VB.Form frmCQ_sistema_tipo 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Qualidade - Controle de documentos e dados - Tipo"
   ClientHeight    =   4920
   ClientLeft      =   120
   ClientTop       =   390
   ClientWidth     =   6870
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmCQ_sistema_tipo.frx":0000
      Count           =   1
   End
   ...
   End
End
Attribute VB_Name = "frmCQ_sistema_tipo"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Novo_CQsistema_Tipo As Boolean
    ...
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            If Permitido = False Then
                If USMsgBox("Deseja realmente excluir este(s) tipo(s)?", vbYesNo, "CAPRIND v5.0") = vbYes Then GoTo 1 Else Exit Sub
            End If
1:
            Permitido = True
            Conexao.Execute "DELETE from CQ_Sistema_Tipo where ID = " & .ListItems(InitFor)
            '==================================
            Modulo = "Qualidade/Controle de documentos e dados/Tipo"
            Evento = "Excluir"
            ID_documento = .ListItems(InitFor)
            Documento = "Tipo: " & .ListItems(InitFor).SubItems(1)
            Documento1 = ""
            ProcGravaEvento
            '==================================
        End If
...
Else
    USMsgBox ("Tipo(s) excluído(s) com sucesso."), vbInformation, "CAPRIND v5.0"
    ProcLimpaCampos
    ProcAtualizalista
...
TBGravar.Open "Select * from CQ_Sistema_Tipo where id = " & txtId, Conexao, adOpenKeyset, adLockOptimistic
...
TBLISTA.Open "Select * from CQ_Sistema_Tipo order by Tipo", Conexao, adOpenKeyset, adLockOptimistic
...
frmCQ_sistema.Cmb_tipo = Lista.SelectedItem.SubItems(1)
Unload Me
...
TBAbrir.Open "Select * from CQ_Sistema_Tipo where id = " & Lista.SelectedItem, Conexao, adOpenKeyset, adLockOptimistic
