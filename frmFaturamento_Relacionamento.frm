   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CheckBox chkEmitente 
            ...
            Left            =   270
            TabIndex        =   57
            ToolTipText     =   "Se marcado filtra notas de qualquer emitente com o mesmo código do item."
            Top             =   210
            Width           =   2835
         End
    ...
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            If PagarParcial = False Then
                ...
                If USMsgBox("Alguma nota selecionada será relacionada com quantidade parcial?", vbYesNo, "CAPRIND v5.0") = vbYes Then Encontrou = True
            End If
            PagarParcial = True
...
'==============================================================================
' Se for nota de saida relaciona com notas de terceiros (Venda com devolução de MP)
'==============================================================================
    'If .Opt_saida = True And Formulario = "Faturamento/Nota fiscal/Própria" Or .Opt_saida = True And Formulario = "Estoque/Ordem de faturamento" Then
    ...
    'End If
'==============================================================================
' Se for nota de entrada relaciona com notas de propria (Devolução)
'==============================================================================
    If .opt_Entrada = True And Formulario = "Faturamento/Nota fiscal/Própria" Then
    TextoFiltroTipo = "and NF.int_tiponota = 1 and NF.ID <> " & .txtId
