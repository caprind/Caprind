...
Begin VB.Form frm_Orcamento_conjunto_item 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   Caption         =   "Vendas - Orçamentos | Conjuntos | Localizar itens"
   ClientHeight    =   5700
   ClientLeft      =   0
   ClientTop       =   -75
   ClientWidth     =   9240
   ...
   Begin DrawSuite2022.USForm USForm1 
      ...
      _ExtentX        =   16298
      _ExtentY        =   741
      DibPicture      =   "frm_orcamento_conjunto_item.frx":0000
      CaptionDelimiter=   "|"
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Icon            =   "frm_orcamento_conjunto_item.frx":3650
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frm_orcamento_conjunto_item.frx":396A
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frm_orcamento_conjunto_item.frx":7111
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frm_orcamento_conjunto_item.frx":AC27
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frm_orcamento_conjunto_item.frx":ED21
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin DrawSuite2022.USButton btnFiltrar 
         ...
         _ExtentX        =   3519
         _ExtentY        =   1879
         DibPicture      =   "frm_orcamento_conjunto_item.frx":125ED
         BorderColor     =   5263559
      ...
      Begin VB.ComboBox Cmb_ordenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_orcamento_conjunto_item.frx":15C3D
         Left            =   3780
         List            =   "frm_orcamento_conjunto_item.frx":15C47
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_orcamento_conjunto_item.frx":15C66
         Left            =   180
         List            =   "frm_orcamento_conjunto_item.frx":15C8E
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frm_Orcamento_conjunto_item"
...
With frm_Orcamento_Conjunto
    ...
    Cod_produto = TBItem!Codproduto
     ...
     .cmbunkg.Text = TBItem!Un_Kg
     .txtpeso = TBItem!PBruto
     .txtComprimento2 = IIf(IsNull(TBItem!Comprimento), "", Format(TBItem!Comprimento, "###,##0.0"))
     .cmbfamilia.Text = IIf(IsNull(TBItem!Classe), "", TBItem!Classe)
     .txtLargura2.Text = IIf(IsNull(TBItem!Largura), "", TBItem!Largura)
     .txtLote = "1,00"
    End If
    TBItem.Close
