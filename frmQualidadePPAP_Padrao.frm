...
Begin VB.Form frmQualidadePPAP_Padrao 
   ...
   Caption         =   "Qualidade - PPAP - PSW - Submissão - Declaração - Texto padrão"
   ClientHeight    =   5580
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   7590
...
If TBAbrir.BOF = False Then
    ...
    If TBAbrir.BOF = False Then
        ...
        ProcCarregaDados
    Else
        USMsgBox ("Fim dos cadastros de textos padrão."), vbInformation, "CAPRIND v5.0"
    End If
End If
...
With Lista
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            ...
            '====================================
            Modulo = "Qualidade/PPAP/PSW/Submissão/Declaração/Texto padrão"
            Evento = "Excluir"
