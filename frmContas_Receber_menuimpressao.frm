...
Begin VB.Form frmContas_Receber_menuimpressao 
   BackColor       =   &H00E0E0E0&
   ...
   End
End
Attribute VB_Name = "frmContas_Receber_menuimpressao"
...
With frmContas_Receber
    ...
    Else
        ProcImprimirRel .FormulaRel_Contas_Receber & " and {Producao_Relatorios_Total.Responsavel} = '" & pubUsuario & "' and {Producao_Relatorios_Total.Modulo} = '" & Formulario & "'", ""
    End If
End With
...
NomeRel = "Contas_receber_duplicata.rpt"
With frmContas_Receber
    ProcVerificaContasSelRel .Lista, IIf(.Cmb_opcao_lista = "Relatório", True, False)
    If Familiatext <> "" Then
        ProcImprimirRel Familiatext, ""
    Else
        ProcImprimirRel .FormulaRel_Contas_Receber, ""
    End If
End With
...
NomeRelAntigo = NomeRel
NomeRel = "Contas_receber_resumido.rpt"
With frmContas_Receber
    ProcVerificaContasSelRel .Lista, IIf(.Cmb_opcao_lista = "Relatório", True, False)
    If Familiatext <> "" Then
        ProcImprimirRel "(" & Familiatext & ") and {Producao_Relatorios_Total.Responsavel} = '" & pubUsuario & "' and {Producao_Relatorios_Total.Modulo} = '" & Formulario & "'", ""
