...
Begin VB.Form frmOpcoesGeral2_Subs 
   ...
   Caption         =   "Sistema - Opções gerais - Localizar banco de dados - Altera caminho do banco de dados"
   ClientHeight    =   3270
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   8100
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmOpcoesGeral2_Subs.frx":57EE
      Count           =   1
   End
   Begin DrawSuite2022.USToolBar USToolBar1 
      ...
      Theme           =   1
      ButtonCaption1  =   "Alterar"
      ButtonEnabled1  =   0   'False
      ButtonIconSize1 =   32
      ButtonToolTipText1=   "Alterar (Insert)"
      ButtonKey1      =   "1"
      ButtonAlignment1=   2
...
If USMsgBox("Deseja utilizar o caminho selecionado?", vbYesNo, "CAPRIND v5.0") = vbYes Then
    ...
    FunAbreBD
    USMsgBox "As alterações foram efetuadas com sucesso.", vbInformation, "CAPRIND v5.0"
    Unload Me
    
    With frmMDI
        .Caption = VarE & " - Caprind v" & App.Major & "." & App.Minor & "." & App.Revision & " - Menu Principal"
        ProcMontaStatusBar
      '  .StatusBar1.Panels(1).Text = "Usuário conectado ao sistema: " & pubUsuario & " - Nome do banco de dados: " & Nome_banco & Familiatext
    End With
    ProcVerificaUsuario
End If
...
Private Sub ProcVerificaUsuario()
On Error GoTo tratar_erro

Set TBUsuarios = CreateObject("adodb.recordset")
TBUsuarios.Open "Select Usuario from Usuarios where Usuario = '" & pubUsuario & "'", Conexao, adOpenKeyset, adLockOptimistic
If TBUsuarios.EOF = False Then
    ProcRecarregaMenu
Else
    USMsgBox ("Não foi encontrado o usuário " & pubUsuario & " no banco de dados atual, o sistema será fechado."), vbInformation, "CAPRIND v5.0"
    FunFechaBD
    End
End If
TBUsuarios.Close
...
ProcCarregaToolBar1 Me, 7980, 5, True
