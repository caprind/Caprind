...
Begin VB.Form frmVendas_propostaII_atualizar 
   Appearance      =   0  'Flat
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Vendas - Proposta comercial - Atualizar"
   ClientHeight    =   2070
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   4515
   ...
   Begin DrawSuite2022.USToolBar USToolBar1 
      ...
      Begin DrawSuite2022.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "frmVendas_propostaII_atualizar.frx":0000
         Count           =   1
      End
   End
   Begin VB.Frame Frame2 
      ...
      Begin VB.CheckBox Chk3 
         BackColor       =   &H00E0E0E0&
         Caption         =   "03 - Salvar cliente(s) no(s) prod./serviço(s)"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmVendas_propostaII_atualizar"
...
If Vendas_PI = True Then Caption = "Vendas - Pedido interno - Atualizar"
