...
Begin VB.Form frmCompras_fornecedores_RElUF_etiqueta 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Administrativo - Compras - Fornecedores - Gerar etiquetas"
   ClientHeight    =   7365
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   7650
   ...
   EndProperty
   Icon            =   "frmCompras_fornecedores_RElUF_etiqueta.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmCompras_fornecedores_RElUF_etiqueta.frx":030A
      Count           =   1
   End
   Begin VB.TextBox Txt_ID_nome 
      ...
      Left            =   1290
      Locked          =   -1  'True
      MouseIcon       =   "frmCompras_fornecedores_RElUF_etiqueta.frx":431E
   ...
   Begin VB.TextBox txtid 
      ...
      Left            =   930
      Locked          =   -1  'True
      MouseIcon       =   "frmCompras_fornecedores_RElUF_etiqueta.frx":4628
      MousePointer    =   99  'Custom
      TabIndex        =   24
      TabStop         =   0   'False
      Text            =   "0"
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox txtendereco 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_fornecedores_RElUF_etiqueta.frx":4932
         Left            =   1320
         List            =   "frmCompras_fornecedores_RElUF_etiqueta.frx":4934
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbposicao 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_fornecedores_RElUF_etiqueta.frx":4936
         Left            =   1320
         List            =   "frmCompras_fornecedores_RElUF_etiqueta.frx":4976
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   3
      ...
      Begin VB.ComboBox cmbcliente 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_fornecedores_RElUF_etiqueta.frx":49CA
         Left            =   1320
         List            =   "frmCompras_fornecedores_RElUF_etiqueta.frx":49CC
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   5
         ToolTipText     =   "Cliente."
      ...
      Begin VB.ComboBox cmbcontato 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_fornecedores_RElUF_etiqueta.frx":49CE
         Left            =   1320
         List            =   "frmCompras_fornecedores_RElUF_etiqueta.frx":49D0
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   11
   ...
   End
End
Attribute VB_Name = "frmCompras_fornecedores_RElUF_etiqueta"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Novo_Fornecedor_Etiqueta As Boolean 'OK
...
TBClientes.Open "Select * from Compras_fornecedores where IDCliente = " & cmbcliente.ItemData(cmbcliente.ListIndex), Conexao, adOpenKeyset, adLockOptimistic
If TBClientes.EOF = False Then
    ...
    TBAbrir.Open "Select * from Contatos_fornecedor where IDFornecedor = " & TBClientes!IDCliente & " and Nome <> 'Null' order by Nome", Conexao, adOpenKeyset, adLockOptimistic
    If TBAbrir.EOF = False Then
        Do While TBAbrir.EOF = False
            If Nome <> TBAbrir!Nome Then
                cmbcontato.AddItem TBAbrir!Nome
...
txtuf.Text = IIf(IsNull(TBClientes!Estado), "", TBClientes!Estado)
...
txtendereco.Clear
Set TBAbrir = CreateObject("adodb.recordset")
TBAbrir.Open "Select * from clientes_entrega where idcliente = " & TBClientes!IDCliente & " and Tipo = 'F' order by endereco_entrega", Conexao, adOpenKeyset, adLockOptimistic
If TBAbrir.EOF = False Then
    Do While TBAbrir.EOF = False
...
txtendereco.Clear
Set TBAbrir = CreateObject("adodb.recordset")
TBAbrir.Open "Select * from clientes_cobranca where idcliente = " & TBClientes!IDCliente & " and Tipo = 'F'", Conexao, adOpenKeyset, adLockOptimistic
If TBAbrir.EOF = False Then
    Do While TBAbrir.EOF = False
...
Set TBAbrir = CreateObject("adodb.recordset")
TBAbrir.Open "Select * from Contatos_fornecedor where IDcontato = " & cmbcontato.ItemData(cmbcontato.ListIndex), Conexao, adOpenKeyset, adLockOptimistic
If TBAbrir.EOF = False Then
...
frmCompras_fornecedores_RElUF_etiqueta_menuimpressao.Show 1
...
cmbcliente.Clear
Set TBClientes = CreateObject("adodb.recordset")
TBClientes.Open "Select * from Compras_fornecedores where DtValidacao IS NOT NULL order by Nome_Razao", Conexao, adOpenKeyset, adLockOptimistic
If TBClientes.EOF = False Then
    Do While TBClientes.EOF = False
        cmbcliente.AddItem TBClientes!Nome_Razao
...
With lst_clientes
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            ...
            '==================================
            Modulo = "Compras/Fornecedores/Etiqueta"
            Evento = "Excluir"
...
Else
    ...
    Novo_Fornecedor_Etiqueta = False
End If
...
End If
Set TBAbrir = CreateObject("adodb.recordset")
TBAbrir.Open "Select * from etiqueta where Tipo = 'F' and Modulo = '" & Formulario & "' and Responsavel = '" & pubUsuario & "' and posicao = " & cmbposicao.Text & " and id <> " & txtId & " and Tipo = 'C'", Conexao, adOpenKeyset, adLockOptimistic
If TBAbrir.EOF = False Then
...
If Novo_Fornecedor_Etiqueta = True Then
    ...
    TBFI.Open "Select posicao from etiqueta where posicao <> 0 and posicao <> " & Cont & " and Tipo = 'F' and Modulo = '" & Formulario & "' and Responsavel = '" & pubUsuario & "' order by posicao", Conexao, adOpenKeyset, adLockOptimistic
    ...
    Do While i <> Cont
        ...
        TBGravar.Open "Select * from etiqueta where posicao = " & i & " and Tipo = 'F' and Modulo = '" & Formulario & "' and Responsavel = '" & pubUsuario & "'", Conexao, adOpenKeyset, adLockOptimistic
...
Evento = "Salvar"
ID_documento = txtId
Documento = "Fornecedor: " & cmbcliente
Documento1 = ""
ProcGravaEvento
'==================================
Novo_Fornecedor_Etiqueta = False
...
TBLISTA.Open "Select * from etiqueta where Tipo = 'F' and Modulo = '" & Formulario & "' and Responsavel = '" & pubUsuario & "' order by posicao", Conexao, adOpenKeyset, adLockOptimistic
