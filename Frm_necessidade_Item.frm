...
Begin VB.Form Frm_necessidade_Item 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Necessidade - Alterar requisição de material da ordem - Localizar produtos"
   ClientHeight    =   6360
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   8925
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "Frm_necessidade_Item.frx":0000
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "Frm_necessidade_Item.frx":37A7
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "Frm_necessidade_Item.frx":72B9
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "Frm_necessidade_Item.frx":B3AF
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "Frm_necessidade_Item.frx":EC51
         Left            =   180
         List            =   "Frm_necessidade_Item.frx":EC70
         Sorted          =   -1  'True
   ...
   Begin DrawSuite2022.USToolBar USToolBar1 
      ...
      Begin DrawSuite2022.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "Frm_necessidade_Item.frx":ECE4
         Count           =   1
      End
   End
   ...
   End
End
Attribute VB_Name = "Frm_necessidade_Item"
...
CamposFiltro = "P2.Codproduto, P2.Desenho, P2.Unidade, P2.descricao, P2.classe"
INNERJOINTEXTO = "Select " & CamposFiltro & " from ((Projproduto P1 INNER JOIN Projproduto P2 ON P2.ID_Similar = P1.ID_Similar) LEFT JOIN item_aplicacoes IA ON IA.Codproduto = P2.Codproduto) LEFT JOIN Projproduto_fabricante PFAB ON PFAB.Codproduto = P2.codproduto"
If PCP_AlterarRM = True Then Desenho = frmprod_alterarRM.txtdesenho Else Desenho = Frm_necessidade_RM.txtdesenho
TextoFiltroPadrao = "P1.Desenho = '" & Desenho & "' and P2.Desenho <> '" & Desenho & "' group by " & CamposFiltro & " order by P2.desenho"
If txtTexto.Visible = True And txtTexto <> "" Or cmbfamilia.Visible = True And cmbfamilia <> "" Then
    If cmbfiltrarpor = "Família" Then
        StrSqlLocProdPadrao = INNERJOINTEXTO & " where P2.classe = '" & cmbfamilia & "' and " & TextoFiltroPadrao
    ElseIf cmbfiltrarpor = "Comprimento" Or cmbfiltrarpor = "Largura" Or cmbfiltrarpor = "Espessura" Then
            Select Case cmbfiltrarpor
                Case "Comprimento": TextoFiltro = "P2.Comprimento"
                Case "Largura": TextoFiltro = "P2.Largura"
                Case "Espessura": TextoFiltro = "P2.Espessura"
            End Select
            valor = txtTexto
        ...
        Else
            Select Case cmbfiltrarpor
                Case "Código interno": TextoFiltro = "P2.desenho"
                Case "Código de referência": TextoFiltro = "IA.N_referencia"
                Case "Descrição": TextoFiltro = "P2.descricao"
                Case "Dureza": TextoFiltro = "P2.Dureza"
...
If PCP_AlterarRM = True Then
    Caption = "PCP - Requisição da ordem - Localizar produtos"
    Familiatext = "P"
    IDConta = frmprod_alterarRM.Lista.SelectedItem.ListSubItems(13)
Else
    ...
    ElseIf PCP_Necessidade = True Then
        ...
        Else
            Familiatext = "T"
    End If
    IDConta = Frm_necessidade.Cmb_empresa.ItemData(Frm_necessidade.Cmb_empresa.ListIndex)
End If
ProcFiltroPadrao cmbfiltrarpor, Optmeio, Optfim, optIgual, IDConta, "Produtos/Serviços", Familiatext, True
...
TBItem.Open "select Desenho, Unidade, unidade_com, descricaotecnica from projproduto where codproduto = " & ListView1.SelectedItem, Conexao, adOpenKeyset, adLockOptimistic
If TBItem.EOF = False Then
    If PCP_AlterarRM = True Then
        With frmprod_alterarRM
            .txtDesenho_Similar = IIf(IsNull(TBItem!Desenho), "", TBItem!Desenho)
            .txtUn_Similar = IIf(IsNull(TBItem!Unidade), "", TBItem!Unidade)
            .txtUN_com_Similar = IIf(IsNull(TBItem!Unidade_com), "", TBItem!Unidade_com)
            .txtDesc_Similar = IIf(IsNull(TBItem!descricaotecnica), "", TBItem!descricaotecnica)
        End With
    Else
        With Frm_necessidade_RM
            .txtDesenho_Similar = IIf(IsNull(TBItem!Desenho), "", TBItem!Desenho)
            .txtUn_Similar = IIf(IsNull(TBItem!Unidade), "", TBItem!Unidade)
            .txtUN_com_Similar = IIf(IsNull(TBItem!Unidade_com), "", TBItem!Unidade_com)
            .txtDesc_Similar = IIf(IsNull(TBItem!descricaotecnica), "", TBItem!descricaotecnica)
