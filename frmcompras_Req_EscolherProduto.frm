...
Begin VB.Form frmcompras_Req_EscolherProduto 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Outros - Solicitação - Localizar produtos/serviços"
   ClientHeight    =   6645
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   8925
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmcompras_Req_EscolherProduto.frx":0000
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmcompras_Req_EscolherProduto.frx":37A7
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmcompras_Req_EscolherProduto.frx":72B4
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmcompras_Req_EscolherProduto.frx":B3A8
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Cmb_ordenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmcompras_Req_EscolherProduto.frx":EC38
         Left            =   6330
         List            =   "frmcompras_Req_EscolherProduto.frx":EC42
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmcompras_Req_EscolherProduto.frx":EC61
         Left            =   180
         List            =   "frmcompras_Req_EscolherProduto.frx":EC83
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmcompras_Req_EscolherProduto.frx":ED0C
      Count           =   1
   End
   ...
   End
End
Attribute VB_Name = "frmcompras_Req_EscolherProduto"
...
If cmbfiltrarpor = "Família" Then
    ...
    cmbfamilia.Clear
    cmbfamilia.AddItem ""
    ProcCarregaComboFamilia cmbfamilia, "familia <> 'Null' and (Compras = 'True' or Fabricacao = 'True')", True
Else
...
If Outros_solicitacaoPCP = True Then TipoProduto = "P.Producao = 'True'" Else TipoProduto = "(P.Compras = 'True' or P.Producao = 'True')"
...
TextoFiltroPadrao = TipoProduto & " and P.DtValidacao IS NOT NULL and P.bloqueado = 'False' group by " & CamposFiltro & " order by " & Ordenar
...
If Outros_solicitacaoPCP = True Then
    aption = "Outros - Solicitação de produção - Localizar produtos/serviços"
    Familiatext = "P"
    nPagto = frmOutros_Solicitacao_PCP.Cmb_empresa.ItemData(frmOutros_Solicitacao_PCP.Cmb_empresa.ListIndex)
Else
    Familiatext = "C"
    nPagto = frmCompras_Requisicao.Cmb_empresa.ItemData(frmCompras_Requisicao.Cmb_empresa.ListIndex)
End If
ProcFiltroPadrao cmbfiltrarpor, Optmeio, Optfim, optIgual, nPagto, "Produtos/Serviços", Familiatext, True
...
If Outros_solicitacaoPCP = True Then
    With frmOutros_Solicitacao_PCP
        .txtCodinterno = Lista.SelectedItem.ListSubItems(1)
        .ProcCarregaProduto
        .txtQS.Text = ""
    End With
Else
    With frmCompras_Requisicao
        .txtN_Estoque.Text = Lista.SelectedItem.ListSubItems(1)
        .ProcCarregaProduto
        .txtQS_est.Text = ""
        .txtQS_com.Text = ""
    End With
