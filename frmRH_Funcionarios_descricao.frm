...
Begin VB.Form frmRH_Funcionarios_descricao 
   ...
   Caption         =   "RH - Cadastro de funcionários - Descrição do curso"
   ClientHeight    =   5580
   ClientLeft      =   -15
   ClientTop       =   225
   ClientWidth     =   6870
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox txtDescricao 
         ...
         TabIndex        =   2
         ToolTipText     =   "Descrição do curso."
         Top             =   390
         Width           =   6405
      End
    ...
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            If Permitido = False Then
                If USMsgBox("Deseja realmente excluir esta(s) descrição(ões) de cursos?", vbYesNo, "CAPRIND v5.0") = vbNo Then Exit Sub
            End If
            Permitido = True
            Conexao.Execute "DELETE from funcionarios_descricao where id = " & .ListItems(InitFor)
            '==================================
            Modulo = "RH/Cadastro de Funcionários"
            Evento = "Excluir cadastro de descrição do curso"
            ID_documento = .ListItems(InitFor)
            Documento = "Descrição do curso: " & .ListItems(InitFor).SubItems(1)
            Documento1 = ""
            ProcGravaEvento
            '==================================
        End If
...
End With
If Permitido = False Then
    USMsgBox ("Informe a(s) descrição(ões) de cursos antes de excluir."), vbExclamation, "CAPRIND v5.0"
Else
    USMsgBox ("Descrição(ões) de cursos excluído(s) com sucesso."), vbInformation, "CAPRIND v5.0"
    ProcLimpaCampos
...
If Novo_descricaocurso = True Then
    If USMsgBox("A descrição do curso ainda não foi salva, deseja salvar antes de fechar o módulo?", vbYesNo) = vbYes Then
        ProcSalvar
...
If txtdescricao = "" Then
    NomeCampo = "a descrição do curso"
    ProcVerificaAcao
    txtdescricao.SetFocus
    Exit Sub
End If
...
If Novo_descricaocurso = True Then
    ...
    Evento = "Novo cadastro de descrição do curso"
Else
    USMsgBox ("Alteração efetuada com sucesso."), vbInformation, "CAPRIND v5.0"
    Evento = "Alterar cadastro de descrição do curso"
...
Modulo = "RH/Cadastro de Funcionários"
ID_documento = txtId
Documento = "Descrição do curso: " & txtdescricao
Documento1 = ""
ProcGravaEvento
'==================================
Novo_descricaocurso = False
