...
Begin VB.Form frmproj_familia_abrir 
   ...
   Caption         =   "Engenharia - Famílias - Localizar"
   ClientHeight    =   2535
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   8895
...
With frmproj_familia
    ...
    If txtFamilia <> "" Then
        If cmbfiltrarpor = "Família" Then TextoFiltro1 = "familia" Else TextoFiltro1 = "Grupo"
...
With cmbAplicacao
    ...
    If Compras_Familia = True Then
        Caption = "Compras - Famílias - Localizar"
        .AddItem "Compras"
        .AddItem "Qualidade"
    End If
    If Vendas_Familia = True Then
        Caption = "Vendas - Famílias - Localizar"
        .AddItem "Vendas"
        .AddItem "Compras"
        .AddItem "PCP"
    End If
    If Qualidade_Familia = True Then
        Caption = "Qualidade - Famílias - Localizar"
        .AddItem "Compras"
        .AddItem "Qualidade"
    End If
End With
cmbfiltrarpor = "Família"
