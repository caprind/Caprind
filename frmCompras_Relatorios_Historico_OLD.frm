...
Begin VB.Form frmCompras_Relatorios_Historico_OLD 
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   ForeColor       =   &H8000000D&
   Icon            =   "frmCompras_Relatorios_Historico_OLD.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10035
   ...
   Begin DrawSuite2014.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmCompras_Relatorios_Historico_OLD.frx":0442
      Count           =   1
   End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox cmbFornecedor 
         BackColor       =   &H00FFFFFF&
         Height          =   315
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":3236
         Left            =   180
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":3238
         MouseIcon       =   "frmCompras_Relatorios_Historico_OLD.frx":323A
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":3544
         Left            =   180
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":3546
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   4
      ...
      Begin VB.ComboBox cmbTexto 
         BackColor       =   &H00FFFFFF&
         Height          =   315
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":3548
         Left            =   3360
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":354A
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   5
         ToolTipText     =   "Texto para pesquisa."
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.ComboBox cmbPor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":354C
         Left            =   630
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":3589
         Style           =   2  'Dropdown List
         TabIndex        =   6
         ToolTipText     =   "Por."
         Top             =   270
      ...
      Begin VB.ComboBox Cmb_ano_de 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":35D7
         Left            =   1260
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":35DE
         Style           =   2  'Dropdown List
         TabIndex        =   10
         ToolTipText     =   "Ano de."
         Top             =   660
      ...
      Begin VB.ComboBox Cmb_ano_ate 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":35EE
         Left            =   1260
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":35F5
         Locked          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   14
         TabStop         =   0   'False
      ...
      Begin VB.ComboBox Cmb_mes_ate 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":3606
         Left            =   630
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":3622
         Style           =   2  'Dropdown List
         TabIndex        =   13
         ToolTipText     =   "Mês até."
         Top             =   1020
      ...
      Begin VB.ComboBox Cmb_mes_de 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":3642
         Left            =   630
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":3649
         Style           =   2  'Dropdown List
         TabIndex        =   9
         ToolTipText     =   "Mês de."
         Top             =   660
      ...
      Begin VB.ComboBox Cmb_ano_de1 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":3659
         Left            =   630
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":3660
         Style           =   2  'Dropdown List
         TabIndex        =   8
         ToolTipText     =   "Ano de."
         Top             =   660
      ...
      Begin VB.ComboBox Cmb_ano_ate1 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_Relatorios_Historico_OLD.frx":3671
         Left            =   630
         List            =   "frmCompras_Relatorios_Historico_OLD.frx":3678
         Style           =   2  'Dropdown List
         TabIndex        =   12
         ToolTipText     =   "Ano até."
         Top             =   1020
   ...
   End
End
Attribute VB_Name = "frmCompras_Relatorios_Historico_OLD"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False

Private Sub ProcCaregaComboFornecedor()
On Error GoTo tratar_erro
cmbFornecedor.Clear

StrSql = "select distinct fornecedor from Compras_pedido where fornecedor is not NULL order by fornecedor"
...
If TBAbrir.EOF = False Then
 cmbFornecedor.AddItem ""
    Do While TBAbrir.EOF = False
        cmbFornecedor.AddItem TBAbrir!Fornecedor
        TBAbrir.MoveNext
    Loop
End If
        ...
        If optDetalhado.Value = True Then
            With Lista.ListItems
                ...
                If TBAbrir.EOF = False Then
                    ...
                    .Item(.Count).SubItems(2) = IIf(IsNull(TBAbrir!Pedido), "", TBAbrir!Pedido)
                    ...
                    .Item(.Count).SubItems(6) = IIf(IsNull(TBAbrir!Descricao), "", TBAbrir!Descricao)
                    .Item(.Count).SubItems(7) = IIf(IsNull(TBAbrir!Familia), "", TBAbrir!Familia)
                    .Item(.Count).SubItems(8) = IIf(IsNull(TBAbrir!Quant_Comp), "", Format(TBAbrir!Quant_Comp, "###,##0.0000"))
                    .Item(.Count).SubItems(9) = IIf(IsNull(TBAbrir!preco_unitario), "", (Format(TBAbrir!preco_unitario, "###,##0.0000")))
                    .Item(.Count).SubItems(10) = IIf(IsNull(TBAbrir!ValorDesconto), "", (Format(TBAbrir!ValorDesconto, "###,##0.0000")))
                    .Item(.Count).SubItems(11) = IIf(IsNull(TBAbrir!VlrIPI), "", (Format(TBAbrir!VlrIPI, "###,##0.00")))
                    .Item(.Count).SubItems(12) = IIf(IsNull(TBAbrir!Valor_ICMS_ST), "", (Format(TBAbrir!Valor_ICMS_ST, "###,##0.00")))
                    .Item(.Count).SubItems(13) = Format(IIf(IsNull(TBAbrir!preco_total), 0, TBAbrir!preco_total) + IIf(IsNull(TBAbrir!VlrIPI), 0, TBAbrir!VlrIPI), "###,##0.00")
                    .Item(.Count).SubItems(14) = IIf(IsNull(TBAbrir!Moeda), "", TBAbrir!Moeda)
                    .Item(.Count).SubItems(15) = IIf(IsNull(TBAbrir!Valor_moeda), "", Format(TBAbrir!Valor_moeda, "###,##0.00"))
                    If IsNull(TBAbrir!Status_Item) = False And TBAbrir!Status_Item <> "" Then
                        If TBAbrir!Status_Item = "N_RECEBIDO" Then .Item(.Count).SubItems(16) = "COMPRADO" Else .Item(.Count).SubItems(16) = TBAbrir!Status_Item
                    End If
                    .Item(.Count).SubItems(17) = IIf(IsNull(TBAbrir!maquina), "", TBAbrir!maquina)
                End If
                TBAbrir.Close
            End With
        Else
...
End Select
        ...
        If cmbFornecedor.Text <> "" Then FamiliaAntiga = FamiliaAntiga & "Fornecedor = '" & cmbFornecedor & "' and "
...
If optDetalhado.Value = True Then
    ...
    Else
        StrSql = "Select * from Compras_relatorios_historico_detalhado where " & FamiliaAntiga & " (Data) <= '" & Date & "' order by Data, IDLista"
    End If
    'Debug.Print StrSql
