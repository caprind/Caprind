...
Begin VB.Form frmQualidadePPAP_PlanoControle_LocalizarProduto 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Qualidade - PPAP - Plano de controle -  Localizar produto"
   ClientHeight    =   6300
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   8925
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdAjuda 
         ...
         Height          =   615
         Left            =   7350
         MouseIcon       =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":0000
         MousePointer    =   99  'Custom
         Picture         =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":0152
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton imgSair 
         ...
         Height          =   615
         Left            =   7980
         MouseIcon       =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":05F4
         MousePointer    =   99  'Custom
         Picture         =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":0746
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdFiltrar 
         ...
         Height          =   615
         Left            =   180
         MouseIcon       =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":0F19
         MousePointer    =   99  'Custom
         Picture         =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":106B
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   Begin MSComctlLib.ListView ListView1 
      ...
      EndProperty
      MouseIcon       =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":17EA
      NumItems        =   3
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":1B04
         Left            =   180
         List            =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":1B2C
         MousePointer    =   99  'Custom
         Sorted          =   -1  'True
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.OptionButton Optfim 
            ...
            Height          =   255
            Left            =   2760
            MouseIcon       =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":1BD1
            MousePointer    =   99  'Custom
            TabIndex        =   9
            Top             =   180
            Width           =   1155
         ...
         Begin VB.OptionButton Optinicio 
            ...
            Height          =   255
            Left            =   180
            MouseIcon       =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":1D23
            MousePointer    =   99  'Custom
            TabIndex        =   8
            Top             =   180
            Value           =   -1  'True
         ...
         Begin VB.OptionButton Optmeio 
            ...
            Height          =   255
            Left            =   1470
            MouseIcon       =   "frmQualidadePPAP_PlanoControle_LocalizarProduto.frx":1E75
            MousePointer    =   99  'Custom
            TabIndex        =   7
            Top             =   180
            Width           =   1275
   ...
   End
End
Attribute VB_Name = "frmQualidadePPAP_PlanoControle_LocalizarProduto"
...
With frmQualidadePPAP_PlanoControle
    ...
    If TBItem.EOF = False Then
        ...
        .txtDescricaoProduto.Text = IIf(IsNull(TBItem!Descricao), "", TBItem!Descricao)
    Else
