...
Begin VB.Form frmVendas_Resultados_Grafico 
   BackColor       =   &H00E0E0E0&
   Caption         =   "Graficos de resultados de vendas"
   ClientHeight    =   10035
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15270
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox cmbPalette 
         Height          =   315
         ItemData        =   "frmVendas_Resultados_Grafico.frx":0000
         Left            =   12030
         List            =   "frmVendas_Resultados_Grafico.frx":0061
      ...
      Begin VB.ComboBox cmbAppearance 
         Height          =   315
         ItemData        =   "frmVendas_Resultados_Grafico.frx":01AC
         Left            =   10680
         List            =   "frmVendas_Resultados_Grafico.frx":01B9
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   390
         Width           =   1335
      ...
      Begin VB.ComboBox cmbStyle 
         Height          =   315
         ItemData        =   "frmVendas_Resultados_Grafico.frx":01D2
         Left            =   8520
         List            =   "frmVendas_Resultados_Grafico.frx":01E5
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   390
         Width           =   2145
      ...
      Begin VB.ComboBox Cmb_empresa 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmVendas_Resultados_Grafico.frx":024C
         Left            =   180
         List            =   "frmVendas_Resultados_Grafico.frx":024E
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   4
         ToolTipText     =   "Empresa."
   ...
   Begin DrawSuite2022.USToolBar USToolBar1 
      ...
      Begin DrawSuite2022.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "frmVendas_Resultados_Grafico.frx":0250
         Count           =   1
      End
   End
End
Attribute VB_Name = "frmVendas_Resultados_Grafico"
