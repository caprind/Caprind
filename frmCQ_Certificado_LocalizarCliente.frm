...
Begin VB.Form frmCQ_Certificado_LocalizarCliente 
   BackColor       =   &H00F9F9F9&
   BorderStyle     =   0  'Nenhum
   Caption         =   "CAPRIND v5.0 | CQ | Certificados| Clientes - Localizar"
   ClientHeight    =   8205
   ClientLeft      =   0
   ClientTop       =   -105
   ClientWidth     =   10995
   ...
   Begin DrawSuite2014.USForm USForm1 
      ...
      _ExtentX        =   19394
      _ExtentY        =   820
      DibPicture      =   "frmCQ_Certificado_LocalizarCliente.frx":0000
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Icon            =   "frmCQ_Certificado_LocalizarCliente.frx":3650
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2014.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCQ_Certificado_LocalizarCliente.frx":396A
      ...
      Begin DrawSuite2014.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCQ_Certificado_LocalizarCliente.frx":7111
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2014.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCQ_Certificado_LocalizarCliente.frx":AC20
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2014.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCQ_Certificado_LocalizarCliente.frx":ED12
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCQ_Certificado_LocalizarCliente.frx":125A1
         Left            =   180
         List            =   "frmCQ_Certificado_LocalizarCliente.frx":125BA
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbstatus 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCQ_Certificado_LocalizarCliente.frx":12610
         Left            =   180
         List            =   "frmCQ_Certificado_LocalizarCliente.frx":1261D
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   5
         ToolTipText     =   "Status."
   ...
   Begin DrawSuite2014.USToolBar USToolBar1 
      ...
      Begin DrawSuite2014.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "frmCQ_Certificado_LocalizarCliente.frx":1263F
         Count           =   1
      End
   End
End
Attribute VB_Name = "frmCQ_Certificado_LocalizarCliente"
