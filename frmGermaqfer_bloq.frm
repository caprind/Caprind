...
If txtStatus = "" Then
    USMsgBox ("Informe se o posto de trabalho está bloqueado ou liberado antes de salvar."), vbExclamation, "CAPRIND v5.0"
    Exit Sub
End If
With frmGermaqfer
    For InitFor = 1 To .ListaMaquina.ListItems.Count
        If .ListaMaquina.ListItems.Item(InitFor).Checked = True Then
            ...
            If TBMaquinas.EOF = False Then
                ...
                Documento = "Código do posto de trabalho: " & TBMaquinas!maquina
                Documento1 = ""
                ProcGravaEvento
                '==================================
            End If
