...
Begin VB.Form frm_Localizarnota 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   Caption         =   "Administrativo | Faturamento - Nota fiscal - Localizar"
   ClientHeight    =   5865
   ClientLeft      =   0
   ClientTop       =   -105
   ClientWidth     =   7110
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.ComboBox Cmb_modelo 
         ...
         ForeColor       =   &H00000000&
         Height          =   360
         ItemData        =   "frm_Localizarnota.frx":0000
         Left            =   90
         List            =   "frm_Localizarnota.frx":0067
         Sorted          =   -1  'True
   ...
   Begin VB.Frame Frame7 
      ...
      Top             =   660
      Width           =   2025
      Begin DrawSuite2022.USCheckBox chkAtiva 
         Height          =   255
         Left            =   120
         TabIndex        =   31
         Top             =   420
         ...
         Value           =   1
      End
      Begin DrawSuite2022.USCheckBox chkCancelada 
         Height          =   255
         Left            =   900
         TabIndex        =   32
         Top             =   420
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.OptionButton OptServico 
         ...
         Width           =   915
      End
      Begin DrawSuite2022.USCheckBox chkentrada 
         Height          =   255
         Left            =   2100
         TabIndex        =   28
         Top             =   300
   ...
   Begin DrawSuite2022.USButton btnFiltrar 
      ...
      _ExtentX        =   5477
      _ExtentY        =   1244
      DibPicture      =   "frm_Localizarnota.frx":05CE
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cmbSerie 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_Localizarnota.frx":3C1E
         Left            =   150
         List            =   "frm_Localizarnota.frx":3C20
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   22
   ...
   Begin DrawSuite2022.USForm USForm1 
      ...
      _ExtentX        =   12541
      _ExtentY        =   926
      DibPicture      =   "frm_Localizarnota.frx":3C22
      CaptionDelimiter=   "|"
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox Cmb_empresa 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_Localizarnota.frx":758C
         Left            =   180
         List            =   "frm_Localizarnota.frx":758E
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
         ToolTipText     =   "Empresa."
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_Localizarnota.frx":7590
         Left            =   180
         List            =   "frm_Localizarnota.frx":75B5
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   1
         ToolTipText     =   "Opções para filtro."
   ...
   End
End
Attribute VB_Name = "frm_Localizarnota"
...
If Left(frmFaturamento_Prod_Serv.Caption, 7) <> "Estoque" Then
'========================================================
' Somente notas ativas
'========================================================

If chkAtiva.Value = Checked And chkCancelada.Value = Unchecked Then
TextAtivaCancelada = "NF.Int_status = 1 and "
End If
        
'========================================================
' Somente notas canceladas
'========================================================
If chkAtiva.Value = Unchecked And chkCancelada.Value = Checked Then
TextAtivaCancelada = "NF.Int_status = 2 and "
End If
End If

TextoModelo = " and Modelo = '" & Left(Cmb_modelo.Text, 2) & "'"
...
With frmFaturamento_Prod_Serv
    ...
    CamposFiltro = "NF.Int_TipoNota, NF.ID, NF.dt_DataEmissao, NF.dt_Saida_Entrada, NF.int_NotaFiscal, NF.TipoNF, NF.Serie, TN.dbl_Valor_Total_Nota, NF.txt_Razao_Nome, NF.txt_CNPJ_CPF, NF.Int_status, NF.Imprimir, NF.ID_empresa, NF.Aplicacao, NF.DtValidacaoOF, NF.DtValidacao, NF.RPS, NF.Modelo"
    ...
    Select Case cmbfiltrarpor
        ...
        Case "Chave de acesso": TextoFiltro = "NFE.chave_acesso"
    End Select
    ...
    If cmbfiltrarpor = "Código interno" Or cmbfiltrarpor = "Código de referência" Or cmbfiltrarpor = "Descrição" Or cmbfiltrarpor = "Pedido cliente" Then
        FiltroPadrao = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF FROM (tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_detalhes_nota NFP ON NF.ID = NFP.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where " & TextoFiltro
        FiltroPadraoTotal = "(tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_detalhes_nota NFP ON NF.ID = NFP.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota"
    ElseIf cmbfiltrarpor = "Nosso número" Then
        FiltroPadrao = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF FROM (tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Detalhes_Recebimento_Nboletos DR ON NF.ID = DR.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where " & TextoFiltro
        FiltroPadraoTotal = "(tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Detalhes_Recebimento_Nboletos DR ON NF.ID = DR.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota"
    ElseIf cmbfiltrarpor = "Pedido interno/Pedido de compra" Then
        FiltroPadrao = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF FROM (tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_proposta_nota PN ON NF.ID = PN.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where " & TextoFiltro
        FiltroPadraoTotal = "(tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_proposta_nota PN ON NF.ID = PN.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota"
    ElseIf cmbfiltrarpor = "Chave de acesso" Then
        FiltroPadrao = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF FROM (tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Dados_Nota_Fiscal_NFE NFE ON NF.ID = NFE.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where " & TextoFiltro
        FiltroPadraoTotal = "(tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Dados_Nota_Fiscal_NFE NFE ON NF.ID = NFE.ID_Nota) LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota"
    End If
    ...
    If txtTexto.Visible = True And txtTexto <> "" Or txtcnpj.Visible = True And txtcnpj <> "__.___.___/____-__" Or txtCpf.Visible = True And txtCpf <> "___.___.___-__" Then
        If cmbfiltrarpor = "CNPJ" Or cmbfiltrarpor = "CPF" Then
            ...
            .Strsql_Faturamento = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota group by " & CamposFiltro & ", NF.int_NotaFiscal HAVING " & TextAtivaCancelada & " NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & DataFiltro & TextoFiltroVal & OrdenarFiltro
            .Strsql_FaturamentoTotal = "Select Sum(TN.dbl_Valor_Total_Nota) as Valor1, Sum(TN.Valor_Total_Receber_Pagar) as Valor2 from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & " " & DataFiltro & " " & TextoFiltroVal & " and NF.Int_status = 1"
            .Strsql_FaturamentoTotalCanc = "Select Sum(TN.dbl_Valor_Total_Nota) as Valor3 from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & " " & DataFiltro & " " & TextoFiltroVal & " and NF.Int_status = 2"
            ...
            .Strsql_FaturamentoNFSe = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where NF.DtValidacao IS NOT NULL AND TipoNF = 'SA' group by " & CamposFiltro & ", NF.int_NotaFiscal HAVING NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & DataFiltro & OrdenarFiltro
        
        If cmbSerie.Text <> " " And Left(frmFaturamento_Prod_Serv.Caption, 7) <> "Estoque" Then
        ...
        If cmbSerie.Text <> " " And Left(frmFaturamento_Prod_Serv.Caption, 7) <> "Estoque" Then
            .Strsql_Faturamento = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota group by " & CamposFiltro & ", NF.int_NotaFiscal HAVING " & TextAtivaCancelada & " NF.serie = '" & cmbSerie.Text & "' and NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " = " & txtTexto & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & DataFiltro & TextoFiltroVal & OrdenarFiltro
            .Strsql_FaturamentoTotal = "Select Sum(TN.dbl_Valor_Total_Nota) as Valor1, Sum(TN.Valor_Total_Receber_Pagar) as Valor2 from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where NF.serie = '" & cmbSerie.Text & "' and NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " = " & txtTexto & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & " " & DataFiltro & " " & TextoFiltroVal & " and NF.Int_status = 1"
            .Strsql_FaturamentoTotalCanc = "Select Sum(TN.dbl_Valor_Total_Nota) as Valor3 from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where NF.serie = '" & cmbSerie.Text & "' and NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " = " & txtTexto & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & " " & DataFiltro & " " & TextoFiltroVal & " and NF.Int_status = 2"
            .Strsql_FaturamentoNFe = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where NF.serie = '" & cmbSerie.Text & "' and NF.DtValidacao IS NOT NULL AND TipoNF <> 'SA' group by " & CamposFiltro & ", NF.int_NotaFiscal HAVING NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " = " & txtTexto & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & DataFiltro & OrdenarFiltro
            .Strsql_FaturamentoNFSe = "Select " & CamposFiltro & ", NF.int_NotaFiscal AS NNF from tbl_Dados_Nota_Fiscal NF LEFT OUTER JOIN tbl_Totais_Nota TN ON NF.ID = TN.ID_Nota where NF.serie = '" & cmbSerie.Text & "' and NF.DtValidacao IS NOT NULL AND TipoNF = 'SA' group by " & CamposFiltro & ", NF.int_NotaFiscal HAVING NF.tiponf = '" & TipoNF & "' and NF.Aplicacao = '" & .Aplicacao & "' and " & TextoFiltro & " = " & txtTexto & " and NF.ID_empresa = " & Cmb_empresa.ItemData(Cmb_empresa.ListIndex) & DataFiltro & OrdenarFiltro
        End If
        ...
        ElseIf cmbfiltrarpor = "Nota fiscal" Or cmbfiltrarpor = "Destinatário" Or cmbfiltrarpor = "Emitente" Then
...
Else
    Cmb_empresa.Text = frmFaturamento_Prod_Serv.txtEmpresa
End If
