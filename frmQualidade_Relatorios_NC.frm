...
Begin VB.Form frmQualidade_Relatorios_NC 
   BackColor       =   &H00E0E0E0&
   Caption         =   "Qualidade - Relatórios - Não conformidade"
   ClientHeight    =   10035
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15270
   ...
   EndProperty
   Icon            =   "frmQualidade_Relatorios_NC.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10035
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.ComboBox cmbPor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmQualidade_Relatorios_NC.frx":0442
         Left            =   630
         List            =   "frmQualidade_Relatorios_NC.frx":0449
      ...
      Begin VB.ComboBox Cmb_mes_de 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmQualidade_Relatorios_NC.frx":0452
         Left            =   630
         List            =   "frmQualidade_Relatorios_NC.frx":047A
         Style           =   2  'Dropdown List
         TabIndex        =   10
         ToolTipText     =   "Mês de."
         Top             =   570
      ...
      Begin VB.ComboBox Cmb_ano_de 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmQualidade_Relatorios_NC.frx":04BB
         Left            =   1260
         List            =   "frmQualidade_Relatorios_NC.frx":04BD
         Style           =   2  'Dropdown List
         TabIndex        =   11
         ToolTipText     =   "Ano de."
         Top             =   570
      ...
      Begin VB.ComboBox Cmb_mes_ate 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmQualidade_Relatorios_NC.frx":04BF
         Left            =   630
         List            =   "frmQualidade_Relatorios_NC.frx":04E7
         Style           =   2  'Dropdown List
         TabIndex        =   12
         ToolTipText     =   "Mês até."
         Top             =   930
      ...
      Begin VB.ComboBox Cmb_ano_ate 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmQualidade_Relatorios_NC.frx":0528
         Left            =   1260
         List            =   "frmQualidade_Relatorios_NC.frx":052A
         Locked          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   13
         TabStop         =   0   'False
      ...
      Begin VB.ComboBox Cmb_ano_de1 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmQualidade_Relatorios_NC.frx":052C
         Left            =   630
         List            =   "frmQualidade_Relatorios_NC.frx":052E
         Style           =   2  'Dropdown List
         TabIndex        =   14
         ToolTipText     =   "Ano de."
         Top             =   570
      ...
      Begin VB.ComboBox Cmb_ano_ate1 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmQualidade_Relatorios_NC.frx":0530
         Left            =   630
         List            =   "frmQualidade_Relatorios_NC.frx":0532
         Style           =   2  'Dropdown List
         TabIndex        =   15
         ToolTipText     =   "Ano até."
         Top             =   930
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmQualidade_Relatorios_NC.frx":0534
      Count           =   1
   End
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmQualidade_Relatorios_NC.frx":3328
         Left            =   180
         List            =   "frmQualidade_Relatorios_NC.frx":3344
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   4
      ...
      Begin VB.ComboBox cmbTexto 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "frmQualidade_Relatorios_NC.frx":33AC
         Left            =   2760
         List            =   "frmQualidade_Relatorios_NC.frx":33AE
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   6
         ToolTipText     =   "Texto para pesquisa."
   ...
   End
End
Attribute VB_Name = "frmQualidade_Relatorios_NC"
    ...
    Do While TBLISTA.EOF = False
        If optDetalhado.Value = True Then
            With Lista.ListItems
                ...
                .Item(.Count).SubItems(11) = IIf(IsNull(TBLISTA!qtdeNC), 0, TBLISTA!qtdeNC)
                .Item(.Count).SubItems(12) = IIf(IsNull(TBLISTA!Terceiros), "", TBLISTA!Terceiros)
                .Item(.Count).SubItems(13) = IIf(IsNull(TBLISTA!Numero2), "", Format(TBLISTA!Numero2, "###,##0.00"))
                .Item(.Count).SubItems(14) = IIf(IsNull(TBLISTA!impostos), "", TBLISTA!impostos)
                .Item(.Count).SubItems(15) = IIf(IsNull(TBLISTA!Numero3), "", Format(TBLISTA!Numero3, "###,##0.00"))
                .Item(.Count).SubItems(16) = IIf(IsNull(TBLISTA!Lucro), "", TBLISTA!Lucro)
                .Item(.Count).SubItems(17) = IIf(IsNull(TBLISTA!Numero4), "", Format(TBLISTA!Numero4, "###,##0.00"))
                .Item(.Count).SubItems(18) = IIf(IsNull(TBLISTA!material), "", TBLISTA!material)
                .Item(.Count).SubItems(19) = IIf(IsNull(TBLISTA!Numero5), "", Format(TBLISTA!Numero5, "###,##0.00"))
                .Item(.Count).SubItems(20) = IIf(IsNull(TBLISTA!Totalhsutil), "00:00:00", Format(TBLISTA!Totalhsutil, "hh:mm:ss"))
                .Item(.Count).SubItems(21) = IIf(IsNull(TBLISTA!Servicos), "", TBLISTA!Servicos)
                .Item(.Count).SubItems(22) = IIf(IsNull(TBLISTA!Numero6), "", Format(TBLISTA!Numero6, "###,##0.00"))
                .Item(.Count).SubItems(23) = IIf(IsNull(TBLISTA!Total), "", TBLISTA!Total)
                .Item(.Count).SubItems(24) = IIf(IsNull(TBLISTA!Numero7), "", Format(TBLISTA!Numero7, "###,##0.00"))
                .Item(.Count).SubItems(25) = IIf(IsNull(TBLISTA!Total_peca), "", TBLISTA!Total_peca)
                .Item(.Count).SubItems(26) = IIf(IsNull(TBLISTA!Numero8), "", Format(TBLISTA!Numero8, "###,##0.00"))
                
            End With
        Else
            If TBLISTA!maquina <> "" Then
                TextoFiltro = " -  NC    |    Aprov.   |      %      | Aprov. c/ des. |      %      |   Rej.   |      %      |  Retrab.  |      %      |   Selec.  |      %      |  Reapro.  |      %      |   Outros  |     %"
                With Lista1.ListItems
                    ...
                    'Carrega qtde. total
                    Contador1 = 1
                    Do While Lista1.ColumnHeaders(Contador1 + 1).Text <> "Totais -  NC    |    Aprov.   |      %      | Aprov. c/ des. |      %      |   Rej.   |      %      |  Retrab.  |      %      |   Selec.  |      %      |  Reapro.  |      %      |   Outros  |     %"
                        Contador1 = Contador1 + 1
                    Loop
                    
                    SubTipoItem = 10
                    .Item(.Count).SubItems(Contador1) = FunTamanhoTextoZeroEsq(IIf(IsNull(TBLISTA!Numero9), 0, TBLISTA!Numero9), SubTipoItem) & "  |  " & FunTamanhoTextoZeroEsq(IIf(IsNull(TBLISTA!Numero10), 0, TBLISTA!Numero10), 7) & "  |  " & FunTamanhoTextoZeroEsq(IIf(IsNull(TBLISTA!Numero11), "0,00", Format(TBLISTA!Numero11, "###,##0.00")), 6) & "  |  " & FunTamanhoTextoZeroEsq(IIf(IsNull(TBLISTA!Numero12), 0, TBLISTA!Numero12), 11) & "  |  " & FunTamanhoTextoZeroEsq(IIf(IsNull(TBLISTA!Numero13), "0,00", Format(TBLISTA!Numero13, "###,##0.00")), 6) & "  |  " & FunTamanhoTextoZeroEsq(IIf(IsNull(TBLISTA!Numero14), 0, TBLISTA!Numero14), 5) & "  |  " & FunTamanhoTextoZeroEsq(IIf(IsNull(TBLISTA!Numero15), "0,00", Format(TBLISTA!Numero15, "###,##0.00")), 6) & _
...
If optResumido.Value = True Then
    ...
    If TBLISTA.EOF = False Then
        Do While TBLISTA.EOF = False
            ...
            If QTNC <> 0 Then QuantsolicitadoN2 = (qtdeliberada / QTNC) * 100 Else QuantsolicitadoN2 = 0 'Percentual (%)
            
            'Aprovado c/ desvio
            qtdeliberar = IIf(IsNull(TBLISTA!qtdeliberar), 0, TBLISTA!qtdeliberar)
            If QTNC <> 0 Then QuantsolicitadoN3 = (qtdeliberar / QTNC) * 100 Else QuantsolicitadoN3 = 0 'Percentual (%)
            
            'Rejeitar
            qt = IIf(IsNull(TBLISTA!qt), 0, TBLISTA!qt)
            If QTNC <> 0 Then QuantsolicitadoN4 = (qt / QTNC) * 100 Else QuantsolicitadoN4 = 0 'Percentual (%)
            
            'Retrabalhar
            Qtd = IIf(IsNull(TBLISTA!Qtd), 0, TBLISTA!Qtd)
            If QTNC <> 0 Then QuantsolicitadoN5 = (Qtd / QTNC) * 100 Else QuantsolicitadoN5 = 0 'Percentual (%)
            
             'Selecionar
            Qtd_Prog = IIf(IsNull(TBLISTA!Qtd_Prog), 0, TBLISTA!Qtd_Prog)
            If QTNC <> 0 Then QuantsolicitadoN6 = (Qtd_Prog / QTNC) * 100 Else QuantsolicitadoN6 = 0 'Percentual (%)
            
            'Reaproveitar
            QTLOTE = IIf(IsNull(TBLISTA!QTLOTE), 0, TBLISTA!QTLOTE)
            If QTNC <> 0 Then QuantsolicitadoN7 = (QTLOTE / QTNC) * 100 Else QuantsolicitadoN7 = 0 'Percentual (%)
            
            'Outros
            quantestoque = IIf(IsNull(TBLISTA!quantestoque), 0, TBLISTA!quantestoque)
            If QTNC <> 0 Then QuantsolicitadoN8 = (quantestoque / QTNC) * 100 Else QuantsolicitadoN8 = 0 'Percentual (%)
...
Else
    ...
    If cmbfiltrarpor = "Disposição" Then
        CamposFiltro = Familiatext & ", Produto, Ordem"
    ElseIf cmbfiltrarpor = "Ordem" Then
            CamposFiltro = Familiatext & ", Produto, ParecerCQ"
        Else
            CamposFiltro = Familiatext & ", Produto, ParecerCQ, Ordem"
    End If
    If Opt_individual.Value = True Then
...
quantidade = TBCarteira!TTNC
TBProdutividade!Qtdetotalprod = quantidade
...
Select Case TBCarteira!ParecerCQ
    ...
    Case "Retrabalhar":
        ...
        TBFI.Open "Select * from Producao_Relatorios where Modulo = '" & Formulario & "' and Responsavel = '" & pubUsuario & "' and Ordem = " & TBCarteira!Ordem & " and " & DataFiltro & " and QtdeOK <> 0", Conexao, adOpenKeyset, adLockOptimistic
        If TBFI.EOF = True Then
            ...
            Select Case cmbPor
                ...
                Case "Mês":
                    ...
                    DataFiltro1 = "Month(Producaofases.Data) >= '" & Qtde & "' and Year(Producaofases.Data) >= '" & Cmb_ano_de & "' and Month(Producaofases.Data) <= '" & Quant & "' and Year(Producaofases.Data) <= '" & Cmb_ano_ate & "'"
                Case "Ano": DataFiltro1 = "Year(Producaofases.Data) >= '" & Cmb_ano_de1 & "' and Year(Producaofases.Data) <= '" & Cmb_ano_ate1 & "'"
            End Select
            Set TBFIltro = CreateObject("adodb.recordset")
            TBFIltro.Open "Select Producaofases.TempoTotal from Producaofases INNER JOIN ordemservico ON Producaofases.IDFase = ordemservico.IDproducao where ordemservico.Ordem = " & TBCarteira!Ordem & " and ordemservico.Retrabalho = 'True' and " & DataFiltro1 & " and Producaofases.CodigoDesc = 2", Conexao, adOpenKeyset, adLockOptimistic
            If TBFIltro.EOF = False Then
                Do While TBFIltro.EOF = False
                    TempoTotalProd = TempoTotalProd + IIf(IsNull(TBFIltro!TempoTotal), 0, TBFIltro!TempoTotal)
                    TBFIltro.MoveNext
...
End Select
If TBProdutividade!qtdeNC <> 0 Then
    TBProdutividade!Numero2 = (TBProdutividade!Terceiros / TBProdutividade!qtdeNC) * 100
    TBProdutividade!Numero3 = (TBProdutividade!impostos / TBProdutividade!qtdeNC) * 100
    TBProdutividade!Numero4 = (TBProdutividade!Lucro / TBProdutividade!qtdeNC) * 100
    TBProdutividade!Numero5 = (TBProdutividade!material / TBProdutividade!qtdeNC) * 100
    TBProdutividade!Numero6 = (TBProdutividade!Servicos / TBProdutividade!qtdeNC) * 100
    TBProdutividade!Numero7 = (TBProdutividade!Total / TBProdutividade!qtdeNC) * 100
    TBProdutividade!Numero8 = (TBProdutividade!Total_peca / TBProdutividade!qtdeNC) * 100
End If
...
With Lista1.ColumnHeaders
    ...
    .Add
    contador = contador + 1
    .Item(contador).Text = "Totais -  NC    |    Aprov.   |      %      | Aprov. c/ des. |      %      |   Rej.   |      %      |  Retrab.  |      %      |   Selec.  |      %      |  Reapro.  |      %      |   Outros  |     %"
    .Item(contador).Alignment = lvwColumnLeft
    .Item(contador).Width = 14000
End With
