...
Begin VB.Form frmManutencao_descricao 
   ...
   Caption         =   "Manutenção - Equipamentos - Descrição padrão do check-list"
   ClientHeight    =   5430
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   7575
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmManutencao_descricao.frx":0000
      Count           =   1
   End
   ...
   End
End
Attribute VB_Name = "frmManutencao_descricao"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Novo_descricao_manutencao As Boolean 'OK
...
TBLISTA.Open "Select * from Manutencao_descricao order by Texto", Conexao, adOpenKeyset, adLockOptimistic
...
ProcLimpaCampos
Novo_descricao_manutencao = True
Frame1.Enabled = True
txtTexto.SetFocus
...
If ColumnHeader = "" Then
    With Lista
        For InitFor = 1 To .ListItems.Count
            ...
            Else
                ProcVerificaRegistroUtilizadoSemMsg "Manutencao_Checklist", "Descricao = '" & .ListItems(InitFor).ListSubItems(1) & "'"
                If Permitido = False Then
                    .ListItems.Item(InitFor).Checked = False
                    GoTo Proximo
                End If
...
frmManutencao.txtDescricao_Check = Lista.SelectedItem.SubItems(1)
Unload Me
...
With Lista
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True And .ListItems.Item(InitFor) = Item Then
            ...
            ProcVerificaRegistroUtilizado "Manutencao_Checklist", "Descricao = '" & .ListItems(InitFor).ListSubItems(1) & "'", "Manutenção/Equipamentos"
...
If Lista.ListItems.Count = 0 Then Exit Sub
Set TBLISTA = CreateObject("adodb.recordset")
TBLISTA.Open "Select * from Manutencao_descricao where id = " & Lista.SelectedItem, Conexao, adOpenKeyset, adLockOptimistic
If TBLISTA.EOF = False Then
    ProcLimpaCampos
    ProcCarregaDados
