...
Begin VB.Form frmproj_produto_estrutura 
   BackColor       =   &H00E0E0E0&
   ...
   ControlBox      =   0   'False
   Icon            =   "frmproj_produto_estrutura.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10035
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.ComboBox cmbVersao 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmproj_produto_estrutura.frx":0442
         Left            =   1710
         List            =   "frmproj_produto_estrutura.frx":0494
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frmproj_produto_estrutura.frx":04E6
         Left            =   180
         List            =   "frmproj_produto_estrutura.frx":04FF
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
      ...
      Begin VB.Image imgFolder 
         Height          =   240
         Left            =   5520
         Picture         =   "frmproj_produto_estrutura.frx":0574
         Top             =   270
         Visible         =   0   'False
         Width           =   240
      End
      Begin VB.Image imgFile 
         Height          =   240
         Left            =   5790
         Picture         =   "frmproj_produto_estrutura.frx":0AFE
         Top             =   270
         Visible         =   0   'False
         Width           =   240
      End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.TextBox Txt_descricao_versao 
         ...
         Width           =   3495
      End
      Begin DrawSuite2014.USButton Cmd_salvar_desc_versao 
         Height          =   585
         Left            =   3630
         TabIndex        =   15
         ...
         _ExtentX        =   1085
         _ExtentY        =   1032
         DibPicture      =   "frmproj_produto_estrutura.frx":1088
   ...
   Begin DrawSuite2014.USToolBar USToolBar1 
      ...
      Begin DrawSuite2014.USImageList USImageList1 
         ...
         _ExtentX        =   900
         _ExtentY        =   767
         Img1            =   "frmproj_produto_estrutura.frx":181A
         Count           =   1
      End
   End
End
Attribute VB_Name = "frmproj_produto_estrutura"
...
With USToolBar1
    .ButtonState(8) = 0
    IDestrutura = IIf(Grid1.Cell(Row, 21).Text = "", 0, Grid1.Cell(Row, 21).Text)
    IDProduto = IIf(Grid1.Cell(Row, 3).Text = "", 0, Grid1.Cell(Row, 3).Text)
    ...
    Else
        IDestrutura = 0
        VersaoEstrutura = Grid1.Cell(Row, 9).Text
    End If
    Set TBAbrir = CreateObject("adodb.recordset")
...
If TBLISTA.EOF = True Then
    ...
    TBLISTA!Modulo = "Engenharia/Estrutura"
...
If USMsgBox("Deseja realmente excluir este registro da estrutura?", vbQuestion + vbYesNo, "CAPRIND v5.0") = vbYes Then
    Set TBProduto = CreateObject("adodb.recordset")
...
If USMsgBox("Deseja agregar um novo registro abaixo deste: " & vbCrLf & "Código interno : " & Desenho & vbCrLf & "Descrição: " & DT & " ", vbYesNo + vbQuestion) = vbYes Then
...
If TBLISTA.EOF = False Then
    ...
    Do While Not TBLISTA.EOF
        ...
        If Permitido = True Then
            ...
            TBGravar!Modulo = "Engenharia/Estrutura"
            ...
            arrNodes(Contador1).Text = TBLISTA!Desenho & vbTab & "" & vbTab & TBLISTA!Codproduto & vbTab & CodRef & vbTab & vbTab & TBLISTA!Descricao & vbTab & vbTab & TBLISTA!Unidade & vbTab & Tipo & vbTab & "" & vbTab & "" & vbTab & "" & vbTab & "" & vbTab & Format(TBLISTA!Largura, "###,##0.00") & vbTab & Format(TBLISTA!Comprimento, "###,##0.00") & vbTab & "" & vbTab & "" & vbTab & Format(valor, "###,##0.00000000") & vbTab & Format(DataValidacao, "dd/mm/yy") & vbTab & RespValidacao
    ...
    With Grid1
        ...
        .Cell(0, 5).Text = "Part number"
        .Cell(0, 6).Text = "Descrição"
        .Cell(0, 7).Text = "Observações"
        .Cell(0, 8).Text = "Un."
        .Cell(0, 9).Text = "Ver."
        .Cell(0, 10).Text = "Vlr./un"
        .Cell(0, 11).Text = "Un/vlr."
        .Cell(0, 12).Text = "Dim/mm"
        .Cell(0, 13).Text = "Vlr./pç"
        .Cell(0, 14).Text = "Largura/mm"
        .Cell(0, 15).Text = "Comprimento/mm"
        .Cell(0, 16).Text = "Qtde."
        .Cell(0, 17).Text = "Total"
        .Cell(0, 18).Text = "Vlr. custo"
        .Cell(0, 19).Text = "Dt. validação"
        .Cell(0, 20).Text = "Resp. validação"
        .Cell(0, 21).Text = "ID estr."
        ...
        .Column(21).Width = 0 'Id estrutura
...
If IDProduto = 0 Then
    ...
    Exit Sub
End If
If USMsgBox("Deseja realmente copiar essa estrutura?", vbQuestion + vbYesNo, "CAPRIND v5.0") = vbYes Then
    Set TBProduto = CreateObject("adodb.recordset")
...
If IDProduto = 0 Then
    ...
    Exit Sub
End If
If USMsgBox("Deseja realmente criar nova versão para essa estrutura?", vbQuestion + vbYesNo, "CAPRIND v5.0") = vbYes Then
