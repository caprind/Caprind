...
Begin VB.Form frmCompras_programacao_localizar_prod 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Administrativo - Compras - Programação de compra - Localizar produtos/serviços"
   ClientHeight    =   7155
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   8895
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCompras_programacao_localizar_prod.frx":0000
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCompras_programacao_localizar_prod.frx":37A7
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCompras_programacao_localizar_prod.frx":72B6
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmCompras_programacao_localizar_prod.frx":B3AA
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmCompras_programacao_localizar_prod.frx":EC37
      Count           =   1
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Cmb_ordenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_programacao_localizar_prod.frx":10E23
         Left            =   6330
         List            =   "frmCompras_programacao_localizar_prod.frx":10E2D
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmCompras_programacao_localizar_prod.frx":10E4C
         Left            =   180
         List            =   "frmCompras_programacao_localizar_prod.frx":10E71
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmCompras_programacao_localizar_prod"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim StrSqlLocProdCompras As String 'OK
...
Lista.ListItems.Clear
With cmbfamilia
    If cmbfiltrarpor = "Família" Or cmbfiltrarpor = "Fornecedor" Then
        ...
        ElseIf cmbfiltrarpor = "Fornecedor" Then
                ...
                If TBFornecedor.EOF = False Then
                    ...
                    Loop
                    .Text = frmCompras_programacao.txtFornecedor
                End If
                TBFornecedor.Close
        End If
    Else
...
INNERJOINTEXTO = "Select " & CamposFiltro & " from ((Projproduto P LEFT JOIN item_aplicacoes IA ON IA.codproduto = P.codproduto) LEFT JOIN Projproduto_fornecedor PF ON PF.Codproduto = P.Codproduto) LEFT JOIN Projproduto_fabricante PFAB ON PFAB.Codproduto = P.codproduto"
If Cmb_ordenar = "Código interno" Then Ordenar = "P.desenho" Else Ordenar = "P.Descricao"

TextoFiltroForn = ""
If Chk_fornecedor.Value = 1 Then TextoFiltroForn = "and PF.Idfornecedor = " & frmCompras_programacao.txtID_forn

TextoFiltroPadrao = "P.Compras = 'True' and P.bloqueado = 'False' and P.DtValidacao IS NOT NULL " & TextoFiltroForn & " group by " & CamposFiltro & " order by " & Ordenar

If txtTexto.Visible = True And txtTexto <> "" Or cmbfamilia.Visible = True And cmbfamilia <> "" Then
    If cmbfiltrarpor = "Fornecedor" Then
        StrSqlLocProdCompras = INNERJOINTEXTO & " where PF.IDfornecedor = " & cmbfamilia.ItemData(cmbfamilia.ListIndex) & " and " & TextoFiltroPadrao
    ElseIf cmbfiltrarpor = "Família" Then
            StrSqlLocProdCompras = INNERJOINTEXTO & " where P.classe = '" & cmbfamilia & "' and " & TextoFiltroPadrao
        ElseIf cmbfiltrarpor = "Comprimento" Or cmbfiltrarpor = "Largura" Or cmbfiltrarpor = "Espessura" Then
                ...
                StrSqlLocProdCompras = INNERJOINTEXTO & " where " & TextoFiltro & " = " & NovoValor & " and " & TextoFiltroPadrao
            Else
                Select Case cmbfiltrarpor
                ...
                End Select
                StrSqlLocProdCompras = INNERJOINTEXTO & " where " & TextoFiltro & FunVerifTipoFiltroIMF(Optinicio, Optmeio, Optfim, optIgual, txtTexto) & " and " & TextoFiltroPadrao
    End If
Else
    StrSqlLocProdCompras = INNERJOINTEXTO & " where " & TextoFiltroPadrao
End If
ProcCarregaLista
...
ProcFiltroPadrao cmbfiltrarpor, Optmeio, Optfim, optIgual, frmCompras_programacao.Cmb_empresa.ItemData(frmCompras_programacao.Cmb_empresa.ListIndex), "Produtos/Serviços", "C", True
If Permitido = False Then cmbfiltrarpor = "Código interno"

Cmb_ordenar = "Código interno"
If StrSqlLocProdCompras <> "" Then ProcCarregaLista
...
With frmCompras_programacao
    ...
    TBAbrir.Open "Select ID_item from compras_programa_item where ID = " & .txtID.Text & " and codigo = '" & Lista.SelectedItem & "'", Conexao, adOpenKeyset, adLockOptimistic
    If TBAbrir.EOF = False Then
        USMsgBox ("Já existe o produto/serviço " & Lista.SelectedItem.ListSubItems(1) & " na programação de compra nº " & .txtPrograma.Text & "."), vbInformation, "CAPRIND v5.0"
        TBAbrir.Close
        Exit Sub
    End If
    TBAbrir.Close
    .txtCodigo = Lista.SelectedItem.ListSubItems(1)
    .txtdescricao = Lista.SelectedItem.ListSubItems.Item(2)
End With
Unload Me
...
Lista.ListItems.Clear
If StrSqlLocProdCompras = "" Then Exit Sub
Set TBLocalizar_produto_padrao = CreateObject("adodb.recordset")
TBLocalizar_produto_padrao.Open StrSqlLocProdCompras, Conexao, adOpenKeyset, adLockReadOnly
