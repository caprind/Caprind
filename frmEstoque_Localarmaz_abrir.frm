...
If cmbfiltrarpor = "Família" Or cmbfiltrarpor = "Setor" Then
    txtTexto.Visible = False
    cmbfamilia.Visible = True
    If cmbfiltrarpor = "Família" Then ProcCarregaComboFamilia cmbfamilia, "familia <> 'Null'", True Else ProcCarregaComboSetor cmbfamilia, "Setor is not null", "", False, True, False, "", False, False
Else
