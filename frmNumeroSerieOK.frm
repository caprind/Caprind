...
Begin VB.Form frmNumeroSerieOK 
   ...
   Begin DrawSuite2014.USButton cmdGravar 
      Height          =   1215
      Left            =   6210
      TabIndex        =   4
      TabStop         =   0   'False
   ...
   Begin DrawSuite2014.USStatusBar USStatusBar1 
      ...
      _ExtentY        =   714
   End
   Begin DrawSuite2014.USButton cmdExcluir 
      Height          =   1185
      Left            =   8190
      TabIndex        =   5
      TabStop         =   0   'False
      ...
      ToolTipTitle    =   "GERPROD"
   End
   Begin DrawSuite2014.USButton btnDisponiveis 
      Height          =   1155
      Left            =   240
      TabIndex        =   1
      TabStop         =   0   'False
      ...
      ToolTipTitle    =   "GERPROD"
   End
   Begin DrawSuite2014.USButton btnUtilizados 
      Height          =   1155
      Left            =   5220
      TabIndex        =   18
      TabStop         =   0   'False
