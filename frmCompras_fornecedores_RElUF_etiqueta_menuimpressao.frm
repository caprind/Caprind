...
Begin VB.Form frmCompras_fornecedores_RElUF_etiqueta_menuimpressao 
   BackColor       =   &H00E0E0E0&
   ...
   End
End
Attribute VB_Name = "frmCompras_fornecedores_RElUF_etiqueta_menuimpressao"
...
NomeRel = "Fornecedores_envelope.rpt"
ProcImprimirRel "{Etiqueta.posicao} <> 0 and {Etiqueta.Modulo} = '" & Formulario & "' and {Etiqueta.Responsavel} = '" & pubUsuario & "' and {Etiqueta.Tipo} = 'F'", ""
...
NomeRel = "Fornecedores_etiqueta.rpt"
ProcImprimirRel "{Etiqueta.posicao} <> 0 and {Etiqueta.Modulo} = '" & Formulario & "' and {Etiqueta.Responsavel} = '" & pubUsuario & "' and {Etiqueta.Tipo} = 'F'", ""
...
NomeRel = "Fornecedores_etiqueta_personalizada.rpt"
ProcImprimirRel "{Etiqueta.posicao} <> 0 and {Etiqueta.Modulo} = '" & Formulario & "' and {Etiqueta.Responsavel} = '" & pubUsuario & "' and {Etiqueta.Tipo} = 'F'", ""
