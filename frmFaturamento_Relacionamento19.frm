...
Begin VB.Form frmFaturamento_Relacionamento 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmFaturamento_Relacionamento.frx":0000
      ...
      TabPicture(1)   =   "frmFaturamento_Relacionamento.frx":001C
      ...
      Begin VB.Frame Frame9 
         ...
         Begin DrawSuite2014.USButton cmdPagProx 
            ...
            _ExtentX        =   926
            _ExtentY        =   556
            DibPicture      =   "frmFaturamento_Relacionamento.frx":0038
         ...
         Begin DrawSuite2014.USButton cmdPagAnt 
            ...
            _ExtentX        =   926
            _ExtentY        =   556
            DibPicture      =   "frmFaturamento_Relacionamento.frx":37DF
            BorderColor     =   14404026
            BorderColorDown =   11632444
            BorderColorOver =   11632444
            Caption         =   ""
         ...
         Begin DrawSuite2014.USButton cmdPagPrim 
            ...
            _ExtentX        =   926
            _ExtentY        =   556
            DibPicture      =   "frmFaturamento_Relacionamento.frx":72EE
            BorderColor     =   14404026
            BorderColorDown =   11632444
            BorderColorOver =   11632444
            Caption         =   ""
         ...
         Begin DrawSuite2014.USButton cmdPagUlt 
            ...
            _ExtentX        =   926
            _ExtentY        =   556
            DibPicture      =   "frmFaturamento_Relacionamento.frx":B3E2
            BorderColor     =   14404026
            BorderColorDown =   11632444
            BorderColorOver =   11632444
            Caption         =   ""
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.ComboBox cmbfiltrarpor 
            ...
            ForeColor       =   &H00000000&
            Height          =   330
            ItemData        =   "frmFaturamento_Relacionamento.frx":EC7C
            Left            =   180
            List            =   "frmFaturamento_Relacionamento.frx":EC98
            Sorted          =   -1  'True
      ...
      Begin DrawSuite2014.USToolBar USToolBar1 
         ...
         Begin DrawSuite2014.USImageList USImageList1 
            ...
            _ExtentX        =   900
            _ExtentY        =   767
            Img1            =   "frmFaturamento_Relacionamento.frx":ED30
            Count           =   1
         End
      End
      Begin DrawSuite2014.USToolBar USToolBar2 
         ...
         Begin DrawSuite2014.USImageList USImageList2 
            ...
            _ExtentX        =   900
            _ExtentY        =   767
            Img1            =   "frmFaturamento_Relacionamento.frx":11B56
            Count           =   1
         End
      End
    ...
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            If Permitido = False Then
                If MsgBox("Deseja realmente excluir esta(s) nota(s) relacionada(s)?", vbQuestion + vbYesNo) = vbNo Then Exit Sub
            End If
            Permitido = True
...
End With
If Permitido = False Then
    MsgBox ("Informe a(s) nota(s) relacionada(s) antes de excluir."), vbExclamation
Else
    MsgBox ("Nota(s) relacionada(s) excluída(s) com sucesso."), vbInformation
    ...
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            If PagarParcial = False Then
                If MsgBox("Deseja realmente relacionar essa(s) nota(s)?", vbQuestion + vbYesNo) = vbNo Then Exit Sub
                If MsgBox("Alguma nota selecionada será relacionada com quantidade parcial?", vbQuestion + vbYesNo) = vbYes Then Encontrou = True
            End If
            PagarParcial = True
...
End With
If PagarParcial = False Then
    MsgBox ("Informe a(s) nota(s) antes de relacionar."), vbExclamation
Else
    MsgBox ("Nota(s) relacionada(s) com sucesso."), vbInformation
    With frmFaturamento_Prod_Serv
        .ProcCarregaLista
        If .NF_alterada = True Then .ProcCarregaTotaisNota IIf(.TxtID = "", 0, .TxtID)
        .ProcGravarTotaisNota
...
With frmFaturamento_Prod_Serv
    ...
    TBGravar.Open "Select * from Faturamento_Relacionamento where " & TextoFiltro, Conexao, adOpenKeyset, adLockOptimistic
    If TBGravar.EOF = False Then
        If SalvarSimultaneamente = False Then MsgBox ("Alteração efetuada com sucesso."), vbInformation
        Evento = "Alterar"
    ...
    Else
        TBGravar.AddNew
        If SalvarSimultaneamente = False Then MsgBox ("Novo relacionamento cadastrado com sucesso."), vbInformation
        Evento = "Novo"
    ...
    If .Opt_saida.Value = False And Faturamento_NF_Saida = True And Permitido = False Then ProcDevolucao ID_nota_relacionada
End With
...
With frmFaturamento_Prod_Serv
    ...
    If Novo = True Then
        ...
        If TBAbrir.EOF = False Then
            MsgBox ("Não é permitido relacionar esta nota " & ListView1.SelectedItem.ListSubItems(6) & ", pois a mesma já esta relacionada."), vbExclamation
            FunVerificaCamposSalvar = False
            TBAbrir.Close
            Exit Function
        End If
        ...
        If Quantidade > Qtde Then
            MsgBox ("Não é permitido relacionar esta quantidade, pois a mesma é maior que o saldo disponível na nota fiscal " & .txtNFiscal & "."), vbExclamation
            FunVerificaCamposSalvar = False
            Exit Function
        End If
    Else
    ...
    If txtQtde <> "" Then
        ...
        If Quantidade > Qtde Then
            ...
            MsgBox ("Não é permitido relacionar esta quantidade, pois a mesma é maior que a quantidade de " & NomeCampo & "."), vbExclamation
            txtQtde1.SetFocus
            FunVerificaCamposSalvar = False
            Exit Function
        End If
    ...
    If Novo = True Then
        ...
        If TBAbrir.EOF = False Then
            ...
            If Quantidade > Qtde Then
                MsgBox ("Não é permitido relacionar esta quantidade, pois a mesma é maior que o saldo disponível na nota fiscal " & ListView1.SelectedItem.ListSubItems(6) & "."), vbExclamation
                txtQtde1.SetFocus
                FunVerificaCamposSalvar = False
                TBAbrir.Close
                Exit Function
    ...
    Else
        ...
        If TBAbrir.EOF = False Then
            Qtde = TBAbrir!Saldo + TBAbrir!Qtde
            If Quantidade > Qtde Then
                MsgBox ("Não é permitido relacionar esta quantidade, pois a mesma é maior que o saldo disponível na nota fiscal " & ListView2.SelectedItem.ListSubItems(2) & "."), vbExclamation
                txtQtde1.SetFocus
                FunVerificaCamposSalvar = False
                TBAbrir.Close
                Exit Function
...
With frmFaturamento_Prod_Serv
    If Left(.cmbFinalidade_emissao, 1) = 2 Or (Faturamento_NF_Saida = True And .Opt_saida = False) Then
        With ListView1
            .Height = 4080
            .ColumnHeaders(3).Width = 0
            .ColumnHeaders(4).Width = 0
            .ColumnHeaders(5).Width = 0
            .ColumnHeaders(9).Width = 11855
...
With ListView2
    For InitFor = 1 To .ListItems.Count
        If .ListItems.Item(InitFor).Checked = True Then
            ...
            If .ListItems.Item(InitFor).ListSubItems(5) < 0 And .ListItems.Item(InitFor).ListSubItems(5) <> "" Then
                MsgBox "Não é permitido excluir este tipo de relacionamento.", vbExclamation
                .ListItems.Item(InitFor).Checked = False
                Exit Sub
            End If
        End If
...
Do While TBProduto.EOF = False
    ...
    Conexao.Execute "INSERT INTO Faturamento_Relacionamento (ID_nota, ID_produto, ID_nota_relacionada, ID_produto_relacionada, Qtde) VALUES (" & TBProduto!ID_nota & ", " & TBProduto!ID_produto & ", " & TBProduto!ID_nota_relacionada & ", " & TBProduto!id_produto_relacionada & ", " & TBProduto!Qtde * -1 & ")"
    Conexao.Execute "UPDATE tbl_Detalhes_Nota SET Saldo = saldo + " & TBProduto!Qtde & " WHERE Int_codigo = " & id_produto_entrada
    TBProduto.MoveNext
Loop
TBProduto.Close
