...
'==================================
Modulo = "Engenharia/Estrutura/Detalhada"
...
With USToolBar1
    .ButtonState(8) = 0
    IDestrutura = IIf(Grid1.Cell(Row, 20).Text = "", 0, Grid1.Cell(Row, 20).Text)
    IDProduto = IIf(Grid1.Cell(Row, 3).Text = "", 0, Grid1.Cell(Row, 4).Text)
    ...
    Else
        IDestrutura = 0
        VersaoEstrutura = Grid1.Cell(Row, 8).Text
    End If
    Set TBAbrir = CreateObject("adodb.recordset")
...
If TBLISTA.EOF = True Then
    ...
    TBLISTA!Modulo = "Engenharia/Estrutura/Detalhada"
...
If TBLISTA.EOF = False Then
    ...
    Do While Not TBLISTA.EOF
        ...
        If Permitido = True Then
            ...
            TBGravar!Modulo = "Engenharia/Estrutura/Detalhada"
            ...
            arrNodes(Contador1).Text = TBLISTA!Desenho & vbTab & "" & vbTab & "Principal" & vbTab & TBLISTA!Codproduto & vbTab & CodRef & vbTab & TBLISTA!Descricao & vbTab & TBLISTA!Unidade & vbTab & Tipo & vbTab & "" & vbTab & "" & vbTab & "" & vbTab & "" & vbTab & Format(TBLISTA!Largura, "###,##0.00") & vbTab & Format(TBLISTA!Comprimento, "###,##0.00") & vbTab & "" & vbTab & "" & vbTab & Format(valor, "###,##0.00000000") & vbTab & DataValidacao & vbTab & RespValidacao
    ...
    With Grid1
        ...
        .Cell(0, 7).Text = "Un."
        .Cell(0, 8).Text = "Ver."
        .Cell(0, 9).Text = "Vlr./un"
        .Cell(0, 10).Text = "Un/vlr."
        .Cell(0, 11).Text = "Dim/mm"
        .Cell(0, 12).Text = "Vlr./pç"
        .Cell(0, 13).Text = "Largura/mm"
        .Cell(0, 14).Text = "Comprimento/mm"
        .Cell(0, 15).Text = "Qtde."
        .Cell(0, 16).Text = "Total"
        .Cell(0, 17).Text = "Vlr. custo"
        .Cell(0, 18).Text = "Dt. validação"
        .Cell(0, 19).Text = "Resp. validação"
        .Cell(0, 20).Text = "ID estr."
        .Cell(0, 21).Text = "Part number"
        .Cell(0, 22).Text = "Observações"
