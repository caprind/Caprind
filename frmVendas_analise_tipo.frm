...
Begin VB.Form frmVendas_analise_tipo 
   ...
   Caption         =   "Outros - Análise crítica - Tipo"
   ClientHeight    =   4920
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   6870
...
If USMsgBox("Deseja realmente excluir este tipo?", vbYesNo, "CAPRIND v5.0") = vbYes Then
    ...
    USMsgBox ("Tipo excluído com sucesso."), vbInformation, "CAPRIND v5.0"
    '==================================
    Modulo = "Outros/Análise crítica/Tipo"
    Evento = "Excluir"
    ID_documento = txtId
...
ProcAtualizalista
'==================================
Modulo = Modulo = "Outros/Análise crítica/Tipo"
ID_documento = txtId
Documento = "Tipo: " & Txt_tipo
Documento1 = ""
ProcGravaEvento
