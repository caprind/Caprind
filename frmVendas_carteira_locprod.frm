...
Begin VB.Form frmVendas_carteira_locprod 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   0  'None
   Caption         =   "Administrativo - Vendas - Follow up - Localizar produto"
   ClientHeight    =   7230
   ClientLeft      =   0
   ClientTop       =   -105
   ClientWidth     =   8925
   ...
   Begin DrawSuite2022.USForm USForm1 
      ...
      _ExtentX        =   15743
      _ExtentY        =   714
      DibPicture      =   "frmVendas_carteira_locprod.frx":0000
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Icon            =   "frmVendas_carteira_locprod.frx":3650
   ...
   Begin VB.Frame Frame9 
      ...
      Begin DrawSuite2022.USButton cmdPagProx 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmVendas_carteira_locprod.frx":396A
      ...
      Begin DrawSuite2022.USButton cmdPagAnt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmVendas_carteira_locprod.frx":7113
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagPrim 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmVendas_carteira_locprod.frx":AC2E
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
      ...
      Begin DrawSuite2022.USButton cmdPagUlt 
         ...
         _ExtentX        =   926
         _ExtentY        =   556
         DibPicture      =   "frmVendas_carteira_locprod.frx":ED2A
         BorderColor     =   14404026
         BorderColorDown =   11632444
         BorderColorOver =   11632444
         Caption         =   ""
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CheckBox Chk_cliente 
         BackColor       =   &H00E0E0E0&
         Caption         =   "Filtrar produtos do cliente"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
   ...
   Begin DrawSuite2022.USImageList USImageList1 
      ...
      _ExtentX        =   900
      _ExtentY        =   767
      Img1            =   "frmVendas_carteira_locprod.frx":125FF
      Count           =   1
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Cmb_ordenar 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmVendas_carteira_locprod.frx":147E7
         Left            =   6330
         List            =   "frmVendas_carteira_locprod.frx":147F1
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cmbfiltrarpor 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmVendas_carteira_locprod.frx":14810
         Left            =   180
         List            =   "frmVendas_carteira_locprod.frx":14838
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmVendas_carteira_locprod"
        ...
        ElseIf cmbFiltrarPor = "Cliente" Then
                ...
                If TBClientes.EOF = False Then
                    Do While TBClientes.EOF = False
                        ...
                        TBClientes.MoveNext
                    Loop
                    If frmVendas_carteira.txtcliente <> "" Then .Text = frmVendas_carteira.txtcliente
                End If
                TBClientes.Close
            Else
...
If Chk_cliente.Value = 1 And frmVendas_carteira.txtcliente <> "" Then FiltroCliente = "and C.NomeRazao = '" & frmVendas_carteira.txtcliente & "'" Else FiltroCliente = ""
...
TextoFiltroPadrao = "P.vendas = 'True' " & FiltroCliente & " group by " & CamposFiltro & " order by " & Ordenar
If txtTexto.Visible = True And txtTexto <> "" Or cmbFamilia.Visible = True And cmbFamilia <> "" Then
    ...
    ElseIf cmbFiltrarPor = "Grupo do cliente" Then
            StrSqlLocProdPadrao = INNERJOINTEXTO & " where IA.IDGrupo = " & cmbFamilia.ItemData(cmbFamilia.ListIndex) & " and " & TextoFiltroPadrao
...
frmVendas_carteira.txtcodigo.Text = ListView1.SelectedItem.ListSubItems(1)
Unload Me
