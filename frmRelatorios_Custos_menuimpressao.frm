...
Begin VB.Form frmRelatorios_Custos_menuimpressao 
   Appearance      =   0  'Flat
   BackColor       =   &H00E0E0E0&
   ...
   End
End
Attribute VB_Name = "frmRelatorios_Custos_menuimpressao"
...
Unload Me
With frmRelatorios_Custos
    If .cmbfiltrarpor = "Ordem" Then NomeRel = "Custos_resumido_ordem.rpt" Else NomeRel = "Custos_resumido.rpt"
...
Unload Me
NomeRel = "Custos_resumido grafico.rpt"
