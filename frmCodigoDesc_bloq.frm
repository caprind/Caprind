...
Begin VB.Form frmCodigoDesc_bloq 
   ...
   Caption         =   "PCP - Códigos de trabalho - Bloquear/Desbloquear"
   ClientHeight    =   3930
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   6420
...
If txtStatus = "" Then
    USMsgBox ("Informe se o código de trabalho está bloqueado ou liberado antes de salvar."), vbExclamation, "CAPRIND v5.0"
    Exit Sub
End If
With frmCodigoDesc
        ...
        If .Lista.ListItems.Item(InitFor).Checked = True Then
            ...
            If TBCodigoDesc.EOF = False Then
                If txtStatus.Text = "Liberado" Then
                    ...
                    Evento = "Liberar código de trabalho"
                Else
                    TBCodigoDesc!Bloqueado = True
                    Evento = "Bloquear código de trabalho"
                End If
                ...
                Documento = "Descrição: " & TBCodigoDesc!Descricao
                Documento1 = ""
                ProcGravaEvento
                '==================================
            End If
